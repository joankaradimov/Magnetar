...
extern int(*Streamed_SFX_Cleanup)();
extern int(*Streamed_SFX_FullDestructor)();
extern int(*Provider_Destructor)();
extern int(*_ID_Destructor)();
extern int (__stdcall*vector_insert)(int, int);
extern int(*GameNode_Destructor)();
extern int(*SaveGame_Destructor)();
extern int(*_list_unlink)();
...
extern int(*sub_404B20)();
extern int(*ChunkNode_Destructor)();
extern int (__stdcall*sub_404BC0)(int);
...
extern BOOL (__stdcall*SMemFree)(void *location, char *logfilename, int logline, char defaultValue);
extern BOOL (__stdcall*SRegLoadValue)(char *keyname, char *valuename, BYTE flags, int *value);
extern int (__stdcall*SStrNCat)(char *base, char *new_, int max_length);
extern size_t(*SStrVPrintf)(char *dest, size_t size, const char *format, ...);
extern char *(__stdcall*SStrChrR)(const char *string, char c);
extern int (__stdcall*SStrCopy)(char *dest, const char *source, size_t size);
extern int (__stdcall*SStrCmpI)(const char *string1, const char *string2, size_t size);
extern char *(__stdcall*SStrChr)(const char *string, char c);
extern int (__stdcall*SStrLen)(const char *string);
extern int (__stdcall*SNetSendReplayPath)(int a1, int a2, char *replayPath);
extern BOOL (__stdcall*SRegLoadString)(char *keyname, char *valuename, BYTE flags, char *buffer, size_t buffersize);
extern BOOL (__stdcall*SFileOpenArchive)(char *archivename, DWORD dwPriority, DWORD dwFlags, HANDLE handle);
extern BOOL (__stdcall*SFileCloseFile)(HANDLE hFile);
extern BOOL (__stdcall*SFileCloseArchive)(HANDLE hArchive);
extern BOOL (__stdcall*SFileOpenFileEx)(HANDLE hMpq, const char *szFileName, DWORD dwSearchScope, HANDLE *phFile);
extern void (__stdcall*SFileSetLocale)(LCID lcLocale);
extern DWORD (__stdcall*SStrHash)(const char *string, DWORD flags, DWORD Seed);
extern int (__stdcall*SStrCmp)(const char *string1, const char *string2, size_t size);
extern BOOL (__stdcall*SNetGetProviderCaps)(char *caps);
extern BOOL (__stdcall*storm_313)(int maxiterations, int lpSurface, int width, int height, int width2, int pitch, int a7, DWORD rop);
extern BOOL (__stdcall*SVidPlayContinueSingle)(HANDLE video, int a2, int a3);
extern BOOL (__stdcall*storm_458)(HANDLE video);
extern BOOL (__stdcall*storm_454)(char *filename, int arg4, int a3, int a4, int a5, int a6, HANDLE video);
extern DWORD (__cdecl*SErrGetLastError)();
extern HANDLE (__stdcall*SNetRegisterEventHandler)(int type, void (__stdcall *event)(s_evt *evt));
extern BOOL (__stdcall*SNetEnumGamesEx)(int a1, int a2, int (__fastcall *callback)(DWORD, DWORD, DWORD), int *hintnextcall);
extern BOOL (__stdcall*SNetCreateGame)(char *Source, char *a2, char *a3, int a4, int a5, int a6, char *a7, char *a8, int *playerid);
extern BOOL (__cdecl*SNetDestroy)();
extern BOOL (__stdcall*SNetCreateLadderGame)(char *gameName, char *gamePassword, char *gameDataString, int gameType, int a5, int a6, char *GameTemplateData, int GameTemplateSize, int playerCount, char *playerName, char *a11, int *playerID);
extern BOOL (__stdcall*SNetJoinGame)(unsigned int a1, char *gameName, char *gamePassword, char *playerName, char *userStats, int *playerid);
extern BOOL (__stdcall*SNetInitializeProvider)(DWORD providerName, int *providerData, int *userData, int *a4, int *a5);
...
extern BOOL (__stdcall*SBmpLoadImage)(const char *fileName, int size, void *buffer, int buffersize, int width, int height, int depth);
extern int (__stdcall*SNetLeagueLogout)(char *bnetName);
extern BOOL (__stdcall*SDrawCaptureScreen)(char *source);
extern BOOL (__stdcall*STrans442)(int a1, int a2, int a3, char *a4, size_t a5);
extern void (__stdcall*SMemCopy)(void *dest, const void *source, size_t size);
extern void (__stdcall*SErrSetLastError)(DWORD dwErrCode);
extern int (__stdcall*SMemZero)(void *location, size_t length);
extern BOOL (__stdcall*SNetGetNumPlayers)(int *firstplayerid, int *lastplayerid, int *activeplayers);
extern BOOL (__stdcall*SNetGetPlayerName)(int playerid, char *buffer, size_t buffersize);
extern BOOL (__stdcall*SNetSetGameMode)(DWORD modeFlags, char a2);
extern BOOL (__stdcall*SNetLeaveGame)(int type);
extern BOOL (__stdcall*SNetReportGameResult)(unsigned int a1, int size, int a3, int a4, int a5);
extern BOOL (__stdcall*SNet144)(char *buffer);
extern BOOL (__stdcall*SNetGetGameInfo)(int type, char *src, unsigned int length, int *byteswritten);
extern BOOL (__stdcall*SNetDropPlayer)(int playerid, DWORD flags);
extern BOOL (__stdcall*SFileLoadFileEx)(void *hArchive, char *filename, int a3, int a4, int a5, DWORD searchScope, struct _OVERLAPPED *lpOverlapped);
extern BOOL (__stdcall*SFileUnloadFile)(HANDLE hFile);
extern BOOL (__stdcall*SBmpDecodeImage)(int type, signed int *srcbuffer, unsigned int a3, int a4, void *dstbuffer, int size, int a7, int a8, int a9);
extern BOOL (__stdcall*SFileDdaInitialize)(HANDLE directsound);
extern BOOL (__stdcall*SVidInitialize)(HANDLE video);
extern BOOL (__stdcall*SFileDdaBeginEx)(HANDLE directsound, DWORD flags, DWORD mask, unsigned __int32 lDistanceToMove, signed __int32 volume, signed int a6, int a7);
extern BOOL (__cdecl*SVidDestroy)();
extern BOOL (__stdcall*SFileDdaEnd)(HANDLE directsound);
extern BOOL (__cdecl*SFileDdaDestroy)();
extern BOOL (__stdcall*SFileDdaGetPos)(HANDLE directsound, int a2, int a3);
extern BOOL (__stdcall*SNetSendMessage)(unsigned int playerID, char *data, unsigned int databytes);
extern BOOL (__stdcall*SNetReceiveMessage)(int *senderplayerid, BYTE **data, int *databytes);
extern BOOL (__stdcall*SErrGetErrorStr)(DWORD dwErrCode, char *buffer, size_t bufferchars);
extern BOOL (__stdcall*SNetReceiveTurns)(int a1, int arraysize, char **arraydata, unsigned int *arraydatabytes, DWORD *arrayplayerstatus);
extern BOOL (__stdcall*SNetSendTurn)(char *data, unsigned int databytes);
extern BOOL (__stdcall*SNetEnumProviders)(int (__stdcall *callback)(DWORD, DWORD, DWORD));
extern int (__stdcall*SNetGetLeaguePlayerName)(int *curPlayerID, size_t nameSize);
extern int (__stdcall*SNetGetLeagueName)(int leagueID);
extern BOOL (__stdcall*SNetInitializeDevice)(int a1, int a2, int a3, int a4, int *a5);
extern BOOL (__stdcall*SNetEnumDevices)(int (__stdcall *callback)(DWORD, DWORD, DWORD, DWORD), int mincaps);
extern BOOL (__stdcall*SRegSaveString)(char *keyname, char *valuename, BYTE flags, char *string);
extern BOOL (__stdcall*SDlgSetBitmapE)(HWND hWnd, int a2, char *src, int mask1, int flags, int a6, int a7, int width, int a9, int mask2);
extern HANDLE (__stdcall*SDlgDialogBoxIndirectParam)(HMODULE hModule, LPCSTR lpName, HWND hWndParent, LPVOID lpParam, LPARAM lParam);
extern int (__stdcall*Ordinal224)(int a1);
extern HWND (__stdcall*SDrawGetFrameWindow)(HWND sdraw_framewindow);
extern BOOL (__stdcall*SDrawUpdatePalette)(unsigned int firstentry, unsigned int numentries, PALETTEENTRY *pPalEntries, int a4);
extern int (__stdcall*SNetSelectGame)(int a1, int a2, int a3, int a4, int a5, int *playerid);
extern BOOL (__stdcall*SRegLoadData)(char *keyname, char *valuename, BYTE flags, LPBYTE lpData, int size, LPDWORD lpcbData);
extern BOOL (__stdcall*SRegSaveData)(char *keyname, char *valuename, int size, BYTE *lpData, DWORD cbData);
extern BOOL (__stdcall*SFileGetFileArchive)(HANDLE hFile, HANDLE archive);
extern BOOL (__stdcall*SFileGetArchiveName)(HANDLE hArchive, char *name, int length);
extern BOOL (__stdcall*SFileDdaSetVolume)(HANDLE directsound, signed int bigvolume, signed int volume);
extern BOOL (__stdcall*SNet137)(DWORD flags);
extern BOOL (__stdcall*SNetGetTurnsInTransit)(int *turns);
extern BOOL (__stdcall*SRegSaveValue)(char *keyname, char *valuename, BYTE flags, DWORD result);
extern int (__stdcall*SNetSendServerChatCommand)(const char *command);
extern int (__stdcall*SNetSendLeagueCommand)(char *cmd, void *callback);
extern int (__stdcall*SBigPowMod)(void *buffer1, void *buffer2, int a3, int a4);
extern int (__stdcall*SBigDel)(void *buffer);
extern int (__stdcall*SBigToBinaryBuffer)(void *buffer, int length, int a3, int a4);
extern char *(__stdcall*SStrUpper)(char *string);
extern int (__stdcall*SMemFill)(void *location, size_t length, char fillWith);
extern int (__stdcall*SMemCmp)(void *location1, void *location2, size_t size);
extern int (__stdcall*SBigFromBinary)(void *buffer, const void *str, size_t size);
extern int (__stdcall*SBigNew)(void **buffer);
extern BOOL (__stdcall*SRegDeleteValue)(char *keyname, char *valuename, BYTE flags);
extern BOOL (__stdcall*SFileLoadFile)(char *filename, void *buffer, int buffersize, int a4, int a5);
extern BOOL (__stdcall*SNetGetPlayerCaps)(char playerid, int *caps);
extern BOOL (__stdcall*SGdiSelectObject)(HANDLE hObject);
extern HGDIOBJ (__stdcall*SDlgDefDialogProc)(HWND hDlg, signed int DlgType, HDC textLabel, HWND hWnd);
extern BOOL (__stdcall*SDlgEndDialog)(HWND hDlg, HANDLE nResult);
extern BOOL (__stdcall*SGdiExtTextOut)(int a1, int a2, int a3, int a4, unsigned int a8, signed int a6, signed int a7, const char *string, unsigned int arg20);
extern BOOL (__stdcall*SGdiSetPitch)(int pitch);
extern BOOL (__stdcall*SGdiDeleteObject)(HANDLE handle);
extern BOOL (__stdcall*SDlgSetControlBitmaps)(HWND parentwindow, int *id, int a3, char *buffer2, char *buffer, int flags, int mask);
extern BOOL (__stdcall*SBltROP3Clipped)(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10);
extern BOOL (__stdcall*SGdiImportFont)(HGDIOBJ handle, HANDLE *windowsfont);
extern BOOL (__stdcall*Ordinal393)(char *string, int, int);
extern BOOL (__stdcall*SDlgBltToWindowE)(HWND hWnd, HRGN a2, char *a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10);
extern BOOL (__stdcall*STransBlt)(int handle, int a2, int a3, int a4, int a5);
extern BOOL (__stdcall*STransDelete)(int handle);
extern BOOL (__stdcall*STransCreateE)(int a1, int a2, int a3, int bpp, int a5, int bufferSize, int a7);
extern int(*scSpecialChars)();
extern int(*sub_4103A0)();
extern int(*restoreStackPartial)();
extern int (__cdecl*crc32pk)(int, int, int);
...
extern void (__stdcall*SErrSuppressErrors)(bool suppressErrors);
extern BOOL (__stdcall*STransIntersectDirtyArray)(int handle, int dirtyarraymask, unsigned __int8 dirtyarray, int sourcemask);
extern BOOL (__stdcall*SDrawManualInitialize)(HWND hWnd, IDirectDraw *ddInterface, IDirectDrawSurface *primarySurface, int a4, int a5, IDirectDrawSurface *backSurface, IDirectDrawPalette *palette, int a8);
extern BOOL (__stdcall*STransSetDirtyArrayInfo)(int width, int height, int depth, int bits);
extern BOOL (__cdecl*SDrawRealizePalette)();
extern BOOL (__stdcall*STransInvertMask)(int handle, int sourcemask);
extern BOOL (__stdcall*STransDuplicate)(int handle, int source);
extern BOOL (__stdcall*STransCombineMasks)(int handle, int a2, int a3, int a4, int depth, int a6);
extern BOOL (__stdcall*SDrawUnlockSurface)(int surfacenumber, void *lpSurface, int a3, RECT *lpRect);
extern BOOL (__stdcall*SDrawLockSurface)(int surfacenumber, RECT *lpDestRect, void **lplpSurface, int *lpPitch, int arg_unused);
extern BOOL (__stdcall*STransBltUsingMask)(int lpSurface, int a2, int pitch, int width, int handle);
extern void (__stdcall*SRgn523)(int handle, RECT *rect, int reserved, int a4);
extern void (__stdcall*SRgn529i)(int handle, int a2, int a3);
extern void (__stdcall*SRgnCreate)(int handle, int reserved);
extern void (__stdcall*SRgnDelete)(int handle);
extern BOOL (__stdcall*SCodeCompile)(char *directives1, char *directives2, char *loopstring, unsigned int maxiterations, unsigned int flags, HANDLE handle);
extern int (__cdecl*SCodeExecute)(HANDLE handle, int a2);
extern BOOL (__stdcall*SCodeDelete)(HANDLE handle);
extern BOOL (__stdcall*SVidGetSize)(HANDLE video, int width, int height, int zero);
extern int(*sub_411E90)();
extern int(*AES_Comp)();
extern int (__stdcall*MD5_0)(int, int);
extern int(*MD5_1)();
extern int (__stdcall*CopySectionData)(int);
extern int(*sub_413480)();
extern int (__stdcall*ChunkNode_Constructor)(int, int, int);
extern int (__stdcall*sub_413550)(int, int, int);
signed int sub_4135C0(ChkSectionLoader *a1, int a2, int a3);
extern int(*sub_413610)();
extern int(*sub_413640)();
extern int (__stdcall*sub_413670)(int, int);
...
extern int (__thiscall*readCreepFile)(char *filename);
...
extern int(*koreanTextLeadByteCheck)();
...
extern int (__thiscall*sub_416790)(dialog *a1);
...
extern dialog **(__fastcall*removeDlgFromTimerTracking)(dialog *a1, dialog *a2);
extern int(*assignNextActiveDlgElement)();
extern void (__fastcall*sub_4196F0)(dialog *a1, dialog *a2);
...
extern int (__stdcall*sub_41E450)(int);
extern int (__stdcall*SetCurrentPaletteInfo)(char);
extern int(*sub_41E4B0)();
extern int(*sub_41E4F0)();
extern int (__stdcall*sub_41E550)(char, int, char);
extern int(*sub_41E590)();
extern int(*sub_41E5A0)();
extern int(*setPaletteGamma)();
extern int (__stdcall*sub_41E7B0)(int, int);
extern int(*updatePaletteEntries)();
void gluDlgFadePalette(unsigned int a1);
extern int(*colorCycleInterval)();
...
extern int (__fastcall*DSERR_GetString)(size_t size, char *dest);
extern int (__fastcall*DDERR_GetString)(size_t size, char *dest);
...
extern int(*SystemWarning_20MBDiskSpace)();
extern int(*sub_4214C0)();
extern int(*DLGErrFatal)();
extern int(*sub_421510)();
extern void(*FatalError)(char *arg0, ...);
...
extern int (__stdcall*setContourSearchBounds)(int, int);
extern int(*sub_421CB0)();
extern int(*sub_421CD0)();
extern int(*sub_422070)();
extern int(*setContourSearchVariablesFromUnitType)();
...
extern int (__stdcall*sub_422A90)(int);
extern int (__stdcall*sub_422C90)(int);
extern int (__stdcall*sub_422FA0)(int, int);
...
extern int(*BRFACT_Transmission)();
...
extern int (__stdcall*isContourSpaceAvailable)(int, int);
...
extern int(*sai_contoursCreate_Cleanup)();
extern int(*SAI_PathCreate_Sub1_0)();
extern int(*SAI_PathCreate_Sub4)();
...
extern int (__stdcall*CreatePath_PullContours)(int, int, int);
...
extern int (__stdcall*UnitRelManyFinderUMScoutPath)(int, int);
extern int (__stdcall*unkUnitRelManyFinderEx)(int);
extern int (__stdcall*FindAllUnits)(int);
...
extern int (__stdcall*sub_431030)(int);
...
extern int(*calculateUnitStrengths)();
...
extern int (__stdcall*GetStrongestUnitInRegion_AirOrGround)(int);
...
extern int (__stdcall*AI_SCVRepairController)(CUnit *, int);
...
extern char (__stdcall*AI_PatrolController)(CUnit *a1, int a2, int a3);
...
extern int (__stdcall*sub_438E70)(signed int y, signed int x);
...
extern int (__stdcall*AI_GetSpiderMineLocations)(int, int, int);
...
extern int(*sub_43CA30)();
extern int(*sub_43CB00)();
...
extern int (__stdcall*trimPlacement)(int);
extern int (__stdcall*excludePlacementSpotsDifferentHeight)(int, signed int y);
extern int (__stdcall*reserveOnPlacemap)(int, int, int, int, int, __int16);
extern int (__stdcall*excludeNonAIOwnedSpots)(int, int);
extern int (__stdcall*excludePlacementSpotsOutsideRegion)(int, signed int x);
...
extern int (__stdcall*reserveTurretPlacementPosition)(int, int, __int16, __int16, int);
extern int (__stdcall*excludeAddonBuildLocations)(__int16, int, int, __int16);
extern int (__stdcall*reserveBuildingOnPlacemap)(int, int, int);
...
extern int (__stdcall*reservePlayerUnitsOnPlacement)(int, int, int);
extern int (__stdcall*reserveStructureSpacing)(int, int, int);
...
extern int (__stdcall*getBuildPlacementInfo)(int, int, int, int);
extern int (__stdcall*sub_445E80)(int, int);
extern int (__stdcall*AIReservePlacementData)(int, int, int);
extern int(*sub_446350)();
extern signed int (__thiscall*AIManageBuildingPlacement)(CUnit *this_, signed int a2, int a3, int a4, unsigned int a5);
...
extern int (__stdcall*sub_449650)(LPCSTR lpString, int, char, int);
extern int (__stdcall*BattleGetErrorString)(int, int, int, int, int, char *dest, size_t size);
...
extern int(*sub_44E420)();
extern int(*sub_44E4A0)();
extern int(*sub_44E510)();
extern int (__stdcall*makeHash)(int);
extern int (__stdcall*sub_44E780)(int);
...
extern int (__stdcall*sub_44FD30)(int);
...
extern void (__stdcall*dropdownUpdate)(UnknownPlayerRelated *a1, int a2, int a3, char a4, int a5, int a6);
...
extern int (__stdcall*sub_452250)(int);
...
extern int(*Begin_BNET)();
extern int(*sub_452A70)();
extern int(*sub_452A90)();
extern int (__stdcall*sub_452AB0)(int);
extern int(*sub_452BA0)();
extern int (__stdcall*sub_452BD0)(int);
extern int(*OverwriteBNGatewayList)();
extern int (__stdcall*LoadDefaultGatewayList)(int);
extern int(*sub_452EC0)();
extern int (__stdcall*sub_452F00)(int);
extern int (__stdcall*sub_452F40)(char *);
extern int (__stdcall*sub_452F80)(int, int);
extern int(*LoadBNGatewayList)();
...
extern int (__stdcall*parseLocalSBigBuffer)(int, int, int, void *str, size_t size, void *, size_t);
...
extern int(*sub_455500)();
extern int (__fastcall*irradiateUnitDamageProc)(CUnit *a1, CUnit *a2);
extern int (__thiscall*IrradiateDamageLoop)(CUnit *this_);
...
extern signed int (__stdcall*sub_455A00)(CUnit *a1);
...
extern int (__stdcall*SendMapNameData)(int);
extern int (__stdcall*sub_45A010)(char);
extern int(*sub_45A050)();
...
extern int (__fastcall*sub_45A950)(size_t size, char *dest);
...
extern int (__fastcall*sub_45ABE0)(size_t size, char *dest);
extern signed int (__thiscall*sub_45AC10)(int *this_);
extern int(*sub_45AD20)();
extern int(*updatePlayerForce)();
extern int(*sub_45ADE0)();
void sub_45AE20(int a1);
extern int(*isAIScriptNameValid)();
extern int (__stdcall*AI_RunAIScript)(int, int, int);
...
extern int (__stdcall*updateNewUnitVision)(int, int);
...
extern int (__stdcall*DisplayTalkingPortrait_maybe)(__int16, int);
...
extern int (__thiscall*isUnitOwnedByPlayerEx)(void *this_, CUnit *a2);
...
extern int (__thiscall*sub_462930)(CUnit *this_);
...
extern int (__stdcall*orders_ReaverStop)(CUnit *);
...
extern int (__stdcall*getNextStrafePosition)(__int16);
...
extern __int16 (__stdcall*orders_SCVBuild)(CUnit *a1);
...
extern int(*updateUnitSorting)();
extern int(*sub_46A5A0)();
...
extern int (__stdcall*DestinationAndCollisionCheck)(int);
...
extern int (__stdcall*AddBriefingTrigger)(int);
...
extern int (__stdcall*CHK_PerformVCODcheck)(int);
...
extern int(*createUnknownConfirmationBuffer)();
...
extern int(*sub_4719D0)();
extern int(*JoinGame)();
extern int(*sub_471CD0)();
extern int (__stdcall*versionCheck)(int, int playerid, int);
extern int (__stdcall*createVersionBuffer)(__int16, __int16, __int16, char, char, int, int);
...
extern int(*sub_472A70)();
extern int (__stdcall*UserInfo_Constructor)(int, int);
extern int(*sub_472BA0)();
extern int (__stdcall*sub_472C10)(int);
extern int(*sub_472D50)();
extern int(*killTimerFunc)();
extern void (__stdcall*TimerFunc)(HWND, UINT, UINT, DWORD);
extern int(*SetTimerFunc)();
extern int (__stdcall*SetFogMask)(int, int);
extern int (__stdcall*AddFogMask)(int, int);
extern int(*sub_472F00)();
extern int(*sub_472F20)();
extern int (__stdcall*sub_472F40)(int, int);
extern int (__stdcall*getActiveTileFlag)(__int16, int, int);
extern int(*sub_472FD0)();
extern int(*sub_472FF0)();
extern int (__stdcall*canPlaceCreepBuildingAt)(int, __int16, __int16, int, int, int);
extern int (__stdcall*canPlaceNydusBuildingAt)(int, __int16, __int16, int, int);
extern int (__stdcall*sub_473290)(int, int, int);
extern int (__stdcall*sub_4732C0)(int, int, int);
extern int(*j_canUnitTypeFitAt)();
...
extern int (__stdcall*sub_473720)(int, int, int, int, __int16, int, int, int, int);
...
extern int (__stdcall*canPlaceStandardBuildingAt)(int, int, char, __int16, int, int);
extern int (__stdcall*sub_473BD0)(int, __int16, int);
...
extern int(*_orderSelfSpecial)();
extern int (__stdcall*sub_474790)(__int16, __int16);
extern int (__stdcall*sub_4747C0)(Position a5, CUnit *a6);
char *sub_4747E0(CUnit *a1, Order a2, COrder *a3, CUnit *a4);
Order order(int a1, CUnit *a2, Order a3, Position a4, CUnit *a5, u16 a6);
extern int (__stdcall*sub_4748E0)(__int16, __int16);
extern int (__stdcall*sub_474910)(int, __int16, __int16);
extern int(*sub_474940)();
extern int (__stdcall*sub_474980)(int, int);
extern int(*QueueOrder)();
...
extern int (__stdcall*queueNewOrder)(int, char, int, int, int, int);
void orderInterrupt(CUnit *unit, Order order_id, Position a3, CUnit *a4);
extern Order (__stdcall*_doOrder)(CUnit *a1, Order order_id, __int16 a3, __int16 a4, int a5);
...
extern unsigned __int8 (__fastcall*incrementUnitKillCount)(CUnit *a1);
...
extern int (__stdcall*sub_478370)(char);
...
extern int (__stdcall*readImageFile_lowMem)(int, int, int);
extern int (__stdcall*readImageFile)(HANDLE hFile, int, int);
...
extern int (__stdcall*ApplyAllUnitSpeedUpgradesProc)(CUnit *unit, UnitType unit_type, char, int);
void DisableDoodadState(CUnit *a1);
void EnableDoodadState(CUnit *a1);
int orders_WatchTarget(CUnit *a1);
extern int(*ToggleDoodadState)();
...
extern int (__stdcall*assignCenterViewProc)(int);
...
extern int (__stdcall*chatCommandFilter)(int);
...
extern int (__stdcall*gndSightCB_Edge)(int, int, int, int);
extern int (__stdcall*gndSightCB_Inside)(int, int, int, int);
extern int (__stdcall*airSightCB_Edge)(int, int, int, int);
extern int (__stdcall*airSightCB_Inside)(int, int, int, int);
...
extern int (__stdcall*revealSightAtLocation)(signed int x, signed int y, int);
...
extern int(*sub_482070)();
extern int (__stdcall*SAI_PathCreate_Sub3_1_1_0_0)(int);
extern int (__stdcall*SAI_PathCreate_Sub3_1_1_1)(int);
extern int (__stdcall*SAI_PathCreate_Sub3_1_1_0)(int, int, int);
extern int(*SAI_PathCreate_Sub3_1_1)();
extern int (__stdcall*sub_482890)(int);
extern int(*SAI_PathCreate_Sub3_1_0)();
...
extern int (__stdcall*SAI_PathCreate_Sub3_1_2_0)(int);
extern int(*SAI_CreateRegionGroupings)();
extern int (__stdcall*SAI_PathCreate_Sub3_2)(int);
extern int (__stdcall*SAI_PathCreate_Sub3_3)(int);
extern int(*SAI_PathCreate_Sub5)();
extern int(*sub_483200)();
extern int(*sub_483230)();
extern int(*SAI_PathCreate_Sub3_4)();
extern int (__stdcall*SAI_PathCreate_Sub3_0_0)(int, int, __int16);
extern int(*SAI_PathCreate_Sub3_1)();
extern int(*sub_483BD0)();
extern int(*CreateUIUnreachableRegion)();
extern int(*SAI_PathCreate_Sub1)();
extern int(*freeSaiPaths)();
extern int (__stdcall*SAI_PathCreate_Sub3_0)(int, DWORD dwProcessId);
extern int(*SAI_PathCreate_Sub3)();
extern int (__stdcall*SAI_PathCreate)(int);
...
extern void (__thiscall*SetInGameInputProcs)(dlgEvent *);
...
extern int (__stdcall*sub_484F70)(char);
extern int(*getOpenObsPlayerCount)();
extern int(*getNextActivePlayer)();
extern int(*getTeamString)();
extern int(*sub_485130)();
extern int(*sub_485150)();
...
extern int (__stdcall*SendTextMessage)(int, int a2, int);
extern int(*CMDRECV_SetLatency)();
...
extern int (__stdcall*sub_487A10)(int);
...
extern int(*InitializeThingyArray)();
...
extern int (__stdcall*TickCountSomething)(int);
extern int(*PauseGame_maybe)();
...
extern int(*InitializeUnitCounts)();
...
extern int(*countdownTimersExecute)();
extern int(*keyPress_Escape)();
extern int(*AnnouncePlayerEliminated)();
...
extern int(*InitializeBulletArray)();
...
extern BOOL (__thiscall*isUnitDistanceWithin)(CUnit *this_, CBullet *a2, unsigned int a3);
...
extern int(*FindNextBounceTarget)();
...
extern int(*AirSplashProc2)();
extern int(*LurkerSplashProc)();
...
extern int(*InitializeOrderArray)();
...
extern int(*updateTextDisplay)();
extern int(*refreshGameTextIfCounterActive)();
extern int(*refreshGameTextIfFlagIsSet)();
void PrintText(const char *text, u8 color, int tick_count, char a4);
extern int(*resetTextAndLineData)();
extern int(*showStatTxtToPlayer)();
...
extern int (__stdcall*BWFXN_PrintText)(char *source, int);
...
extern int (__stdcall*PlayWorkerErrorSound)(int);
extern int (__stdcall*SetWorkerError)(int);
...
extern int (__stdcall*sub_492620)(int);
...
extern int(*initializePsiFieldData)();
...
extern int(*getFlingyHaltDistance)();
...
extern int(*createUnitBuildingSpriteValidityArray)();
...
extern int (__stdcall*drawMegatileImageData)(int, int);
extern int(*sub_49BB50)();
extern int(*sub_49BB90)();
extern int (__stdcall*sub_49BC20)(int, int, int, int);
...
extern int(*savePlayerSlotTypesAndRace)();
extern int(*sub_49CCA0)();
extern int (__fastcall*airTrainingProc)(CUnit *a1, CUnit *a2);
extern int (__stdcall*sub_49CDC0)(int, int, int, int, int);
...
extern void (__stdcall*sub_49D6C0)(unsigned __int8 a1);
extern int (__stdcall*sub_49D760)(char);
extern int (__stdcall*CreateInitialMeleeBuildings)(char);
extern int(*CreateInitialTeamMeleeUnits)();
extern int(*CreateInitialMeleeUnits)();
...
extern int (__stdcall*displayLastNetErrForPlayer)(char);
...
extern int (__stdcall*AI_CreateUnit)(int, int a4);
...
extern int(*j_calculateUnitStrengths)();
...
extern int(*CreateMinimapSurface)();
...
extern int(*sub_4A3A00)();
extern int(*minimapVisionUpdate_192_256)();
extern int(*minimapVisionUpdate_96_128)();
extern int(*minimapVisionUpdate_64)();
extern int(*sub_4A3D40)();
extern int(*getMinimapCursorPos)();
extern int(*sub_4A3E00)();
extern int(*killMinimapPreviewDlg)();
extern int(*minimapGameResetMouseInput)();
extern void (__fastcall*MinimapImageUpdate)(dialog *dlg, int x, int y, rect *dst);
extern int (__stdcall*drawUnitBox)(int, char, char, char);
extern int(*sub_4A4150)();
extern int(*minimapSurfaceUpdate_192_256)();
extern int(*minimapSurfaceUpdate_96_128)();
extern int(*minimapSurfaceUpdate_64)();
extern int(*setMapSizeConstants)();
extern void (__fastcall*drawMinimapUnitBox)(int player_id);
extern int(*drawMinimapUnitBox2)();
extern int(*drawAllMinimapUnitBoxes)();
...
extern unsigned int (__fastcall*MinimapButtonInteract)(dialog *a1, dlgEvent *a2);
...
extern int (__stdcall*sub_4AAE20)(int, int);
...
extern int (__stdcall*BattleGetResource)(int, int, int size, void *buffer, int buffersize, int width, int height, int depth);
...
extern void (__cdecl*sub_4AF100)();
...
extern int (__stdcall*load_gluModemEntry)(int);
...
extern int (__stdcall*cheatActivation)(int);
extern signed int (__fastcall*_radioFreeZergCheat)(int a1, const void *a2, CheatFlags *cheat_flags);
signed int CommandLineCheatCompare(CheatFlags *game_cheats, const char *a2);
extern int(*sub_4B24B0)();
extern int(*gluCmpgnBtn_UpdateTimer)();
extern int(*gluCmpgnBtn_InitTimer)();
...
extern int (__fastcall*gluCmpgn_Main)(dialog *a3, struct dlgEvent *evt);
...
extern int (__stdcall*sub_4B2D20)(__int16, char);
...
extern int (__stdcall*endgameData)(char *, size_t, char *buff, size_t size);
...
extern void(*loadMenu_gluExpCmpgn)(void);
...
extern int(*loadMenu_gluLoad)();
extern int(*sub_4B6530)();
...
extern bool (__stdcall*BWFXN_gluPEdit_MBox)(char *text, char *dest, size_t size, char *restricted);
...
extern int(*DlgPszTextMemFree)();
extern int (__stdcall*sub_4BA1F0)(int amount);
extern int(*sub_4BA240)();
extern int(*sub_4BA290)();
extern int(*sub_4BA320)();
extern int(*DestroyProviderList)();
void sub_4BA370(dialog *a1, size_t a2, __int16 a3, const char *a4);
extern int (__stdcall*sub_4BA3C0)(int, int, int);
...
extern int (__stdcall*BigPacketError)(int, int, int);
extern int(*sub_4BB4B0)();
extern int (__fastcall*ReceiveTurns)(unsigned int *arraydatabytes, char **arraydata, int a1, int arraysize);
extern int(*CreateSoundBuffer)();
...
extern int(*PlayBriefingWAVBegin)();
...
extern int (__stdcall*sub_4BDB30)(int);
extern int(*sub_4BDD40)();
extern int(*sub_4BDD60)();
extern int (__stdcall*sub_4BDDD0)(int);
extern int (__stdcall*loadColorShiftTilesetImages)(int);
...
extern int(*LoadMap)();
extern int (__stdcall*ReadMapData)(char *source, MapChunks *a4, int a5);
...
extern int(*CMDRECV_restartGame)();
...
extern int(*CMDRECV_ResumeGame)();
extern int(*CMDRECV_PauseGame)();
...
extern signed int (__fastcall*updateBuildingLandUnitSelection)(int a1, CUnit *a2);
extern int(*setup_HUD)();
...
extern int (__stdcall*ApplyGameVictoryStatus)(int);
...
extern int (__thiscall*sub_4C4950)(DWORD flags);
extern int (__stdcall*eventPlayerDropped)(int);
...
extern int (__stdcall*SetAlliance_maybe)(int);
extern signed int (__stdcall*ModifyUnitShields)(CUnit *a1, int a2);
extern int (__stdcall*SubtractDeaths)(int);
extern int (__stdcall*AddDeaths)(int);
extern int (__stdcall*SetDeaths)(int);
extern int (__fastcall*SubtractScore)(unsigned int a1, __int16 a2, int amount);
extern int (__fastcall*AddScore)(unsigned int a1, __int16 a2, int amount);
extern int (__stdcall*SetScore)(int);
extern int (__fastcall*SubtractResource)(unsigned int a1, __int16 a2, int amount);
extern int (__fastcall*AddResource)(unsigned int a1, __int16 a2, int amount);
extern int (__fastcall*SetResource)(unsigned int a1, __int16 a2, int amount);
...
extern int (__stdcall*getUnitForDoodadState)(__int16, int);
extern int(*sub_4C7400)();
...
extern int (__fastcall*TrgOrder)(CUnit *a1, int a2);
...
extern int(*killUnitsAtLocationProc)();
extern signed int (__stdcall*GiveUnits)(CUnit *a1, int a2);
extern int (__stdcall*TriggerKillUnitsAtLocation)(int, __int16, int, int);
extern int (__fastcall*TriggerAction_GiveUnitsToPlayer)(Action *);
signed int sub_4C82C0(int a1, CUnit *a2);
extern int (__fastcall*DestroyUnit_maybe)(int player_id, __int16 a2, int a3, int a4);
...
extern int (__stdcall*ChkLoader_PUNI)(int, int, int);
extern int (__stdcall*ChkLoader_TECS)(int, int, int);
extern int (__stdcall*ChkLoader_TECx)(int, int, int);
extern int (__stdcall*ChkLoader_UPGS)(int, int, int);
extern int (__stdcall*ChkLoader_UPGx)(int, int, int);
extern int (__stdcall*ChkLoader_UNIS)(int, int, int);
extern int (__stdcall*ChkLoader_UNIx)(int, int, int);
extern int(*sub_4CAE90)();
extern int (__stdcall*ChkLoader_FORC)(int, int, int);
extern int (__stdcall*ChkLoader_SPRP)(int, int, int);
extern int (__stdcall*ChkLoader_MASK)(int, int amount, int);
extern int (__stdcall*ChkLoader_DIM)(int, int, int);
extern int(*sub_4CB120)();
extern int (__stdcall*sub_4CB140)(int, int);
extern int(*CHK_UNIT_StartLocationSub)();
extern int(*sub_4CB220)();
extern int (__stdcall*ChkLoader_UPRP)(int, int, int);
extern int (__stdcall*ChkLoader_MRGN_)(int, int, int);
extern int (__stdcall*ChkLoader_MRGN)(int, int, int);
extern int(*sub_4CB340)();
extern void (__thiscall*freeCHKStringHandle)(bool exit_code);
extern int (__stdcall*ChkLoader_ERA)(int, int, int);
extern int (__stdcall*ChkLoader_OWNR)(int, int, int);
extern int (__stdcall*ChkLoader_SIDE)(int, int, int);
extern int (__stdcall*ChkLoader_VER)(int, int, int);
extern int(*sub_4CB560)();
extern int(*sub_4CB5B0)();
extern int(*sub_4CB650)();
extern int (__stdcall*ChkLoader_PTEC)(int, int, int);
extern int (__stdcall*ChkLoader_PTEx)(int, int, int);
extern int (__stdcall*ChkLoader_UPGR)(int, int, int);
extern int (__stdcall*ChkLoader_PUPx)(int, int, int);
extern int (__stdcall*ChkLoader_VCOD)(int, int amount, int);
extern int (__fastcall*CHK_UNIT_Addon)(int a1, CUnit *a2, int a3);
extern int (__stdcall*sub_4CBE00)(char, int);
extern int(*unitNotNeutral)();
extern int (__stdcall*ChkLoader_COLR)(int, int, int);
extern int(*sub_4CBED0)();
extern int (__stdcall*CHK_UNIT_Nydus)(int);
extern int(*sub_4CBF40)();
char sub_4CBF60(int a1, CUnit *a2, __int16 a3);
extern int (__stdcall*ChkLoader_TRIG)(int, int amount, int);
signed int ReadMapChunks(MapChunks *a1, int a2, int *out_version_loader_index, int a4);
extern int (__stdcall*sub_4CC1B0)(int);
extern int (__stdcall*ChkLoader_MBRF)(int, int amount, int);
signed int sub_4CC2A0(int a1, int a2, int a3, MapChunks *a4);
extern int (__fastcall*sub_4CC350)(size_t size, char *source);
extern int (__stdcall*setUnitEnergyEx)(int, char);
extern int (__thiscall*sub_4CC420)(size_t size);
char CHK_UNIT_ApplyOtherFlags(CUnit *a1, char a2, int a3);
void sub_4CC610(CUnit *a1, char a2, int a3);
extern int (__stdcall*ChkLoader_STR)(int, int amount, int);
int sub_4CC7F0(char *a1);
extern int(*sub_4CC990)();
signed int sub_4CCAC0(const char *a1, MapChunks *a2);
char sub_4CCC40(int a1, unsigned __int8 a2, CUnit *a3);
extern int(*ResetDATFiles)();
CUnit *CHK_UNIT_ApplyBurrowFlag(CUnit *result, char a2, CUnit *a3);
extern CUnit *(__stdcall*sub_4CCF90)(_DWORD a1);
extern int (__stdcall*sub_4CD070)(char, int);
extern int(*sub_4CD090)();
extern int (__stdcall*ChkLoader_MTXM)(int, int, int);
...
extern int (__stdcall*ChkLoader_THG2)(int, int amount, int);
extern int(*sub_4CD740)();
extern int(*sub_4CD770)();
extern int (__stdcall*ChkLoader_UNIT)(int, int amount, int);
...
extern int (__stdcall*sub_4CFE40)(int, char *dest, size_t size);
...
extern int (__thiscall*_STrans442_)(int a2);
...
extern int (__stdcall*MainWindowProc)(HWND hWnd, UINT Msg, WPARAM wParam, LPARAM lParam);
...
extern int (__fastcall*sub_4D2770)(int height, int width, int size, void *buffer, int buffersize);
extern void (__fastcall*AllocBackgroundImage)(char *fileName, Bitmap *a2, int *palette, char *source_filename, int source_line);
...
extern int (__fastcall*_ReadFile)(void *buffer, DWORD nNumberOfBytesToRead);
extern int (__stdcall*LoadGraphic)(char *logfilename, int logline);
...
extern void (__cdecl*sub_4D91B0)();
extern void (__cdecl*sub_4D9200)();
...
extern int(*GameLoopWaitSendTurn)();
extern int(*GameLoop_State)();
extern int(*GameLoop_Top)();
...
extern int (__stdcall*SelGameMode)(int);
extern int(*gluMain_DisplayCDRomErrorBinDlg)();
extern bool (__fastcall*gluMain_Dlg_Interact)(dialog *dlg, struct dlgEvent *evt);
extern int(*loadMenu_gluMain)();
extern int (__stdcall*setLastOpenSlotToComputer)(char);
extern int(*sub_4DBBC0)();
extern int(*switchAllAvailableComputerSlotsToOpen)();
extern int(*setSinglePlayerValue)();
int getCampaignIndex(MapData a1, int a2);
extern int (__thiscall*parseCmpgnCheatTypeString)(char *this_, int a2, int a3, int a4, MapData4 *a5);
extern void (__cdecl*sub_4DBD60)();
extern int(*sub_4DBE50)();
extern int(*initSingle)();
extern int(*sub_4DBEC0)();
extern int(*sub_4DBEE0)();
extern int(*sub_4DBF80)();
int CreateCampaignGame(MapData a1);
int LoadCampaignWithCharacter(int a1);
extern int(*_CreateNextCampaignGame)();
...
extern int(*BWFXN_NetSelectReturnMenu)();
...
extern int (__stdcall*get_GluAll_String)(int);
...
extern int(*getReplPlayerColors)();
void getReplPlayerStructs(PlayerInfo *a1);
extern int(*copyPlayerStructsToReplayPlayerStructs)();
...
extern int(*SetGameSpeed_maybe)();
extern int (__stdcall*sub_4DECF0)(char);
extern int(*sub_4DED10)();
extern int (__stdcall*CopyLastreplay)(int);
...
extern void (__thiscall*sub_4E0F50)(dialog *this_);
...
extern int(*networkTBLPlayerMessage)();
...
extern int (__stdcall*sub_4E6C10)(signed int x, signed int y);
...
extern int(*getFirstLoadedWorker)();
...
extern int(*initializeDefaultPlayerNames)();
...
extern int (__stdcall*GetClassWindow)(unsigned __int8 *);
extern int (__thiscall*openDlg)(LPCSTR lpDirectory, unsigned __int8 *, int);
extern int (__stdcall*sub_4EDEF0)(int);
extern int (__stdcall*sub_4EDF20)(int csidl, int);
extern void (__thiscall*destroyFileFindIndexer)(bool exit_code);
extern int(*FastIndexInit)();
extern int (__stdcall*mouseOver_Loading_CB)(int);
extern int(*sub_4EE110)();
extern int(*BWFXN_InitializePlayerConsole)();
extern int(*sub_4EE210)();
extern int(*LoadRaceUI)();
extern int(*sub_4EE3D0)();
extern int(*LoadGameCreate)();
extern int(*sub_4EE5B0)();
extern int(*DestroyGame)();
extern int(*hotkeyRemapping)();
...
extern LONG (__fastcall*SetTargetDlgText)(StatusFlags a1, int a2);
...
extern int (__fastcall*CorrosiveAcidProc)(CUnit *a1, int a2);
extern int (__fastcall*EnsnareProc)(CUnit *a1, CUnit *a2);
void CloakProc(CUnit *a1);
extern int (__stdcall*CorrosiveAcidHit)(int);
void ConsumeHit(CUnit *result, CUnit *a2);
extern int (__thiscall*EnsnareHit)(int position_x, int);
extern int (__stdcall*DarkSwarmHit)(int, __int16, int);
extern unsigned __int8 (__thiscall*BroodlingHit)(void *this_, CUnit *a2, CUnit *a3);
extern int (__fastcall*PlagueProc)(CUnit *a1, CUnit *a2);
extern int (__stdcall*PlagueHit)(int);
...
extern bool (__fastcall*sub_4F5CB0)(dialog *dlg, struct dlgEvent *evt);
extern int (__stdcall*loadOKCancelBIN)(HANDLE phFile);
extern int (__stdcall*loadOKBIN)(HANDLE phFile);
...
extern int (__stdcall*DisruptionWebHit)(int, __int16, int);
...
extern char* aRuntimeError;
extern char* aTlossError;
extern char* aSingError;
extern char* aDomainError;
extern char* aR6029ThisAppli;
extern char* aR6028UnableToI;
extern char* aR6027NotEnough;
extern char* aR6026NotEnough;
extern char* aR6025PureVirtu;
extern char* aR6024NotEnough;
extern char* aR6019UnableToO;
extern char* aR6018Unexpecte;
extern char* aR6017Unexpecte;
extern char* aR6016NotEnough;
extern char* aThisApplicatio;
extern char* aR6009NotEnough;
extern char* aR6008NotEnough;
extern char* aR6002FloatingP;
extern char* aMicrosoftVisua;
...
extern _SCOPETABLE_ENTRY* stru_4FEA48;
...
extern char* aABufferOverrun;
extern char* aBufferOverrunD;
extern char* aASecurityError;
extern char* aUnknownSecurit;
extern _SCOPETABLE_ENTRY& stru_4FEF18;
extern wchar_t* asc_4FF028;
extern const WCHAR& SrcStr;
extern _SCOPETABLE_ENTRY* stru_4FF430;
extern _SCOPETABLE_ENTRY& stru_4FF458;
extern char* aHhMmSs;
extern char* aDdddMmmmDdYyyy;
extern char* aMmDdYy;
extern char* aPm;
extern char* aAm;
extern char* aDecember;
extern char* aNovember;
extern char* aOctober;
extern char* aSeptember;
extern char* aAugust;
extern char* aJuly;
extern char* aJune;
extern char* aApril;
extern char* aMarch;
extern char* aFebruary;
extern char* aJanuary;
extern _SCOPETABLE_ENTRY& stru_4FF590;
extern char& byte_4FF59C;
extern char* aUnmontuewedthu;
extern char& byte_4FF5B4;
extern char* aAnfebmaraprmay;
extern char* aTz;
extern _SCOPETABLE_ENTRY& stru_4FF5E0;
extern _SCOPETABLE_ENTRY& stru_4FF5F0;
extern _SCOPETABLE_ENTRY& stru_4FF600;
extern _SCOPETABLE_ENTRY* stru_4FF610;
extern int (__thiscall *&off_4FF62C)(void *location, char);
extern _SCOPETABLE_ENTRY& stru_4FF630;
...
extern char* aLastreplay_0;
extern int* dword_4FF90C;
extern char* aShow;
...
extern char* aRazings;
extern char* aSlaughter;
extern char* aResources;
extern char* aMinerals;
extern char* aGas;
extern char* aScore;
extern char* aScoreUnits;
extern char* aScoreBuildings;
extern char* aScoreKills;
extern char* aScoreRazings;
extern char* aScoreUser;
extern int* dword_4FFAD4;
extern _DWORD* off_4FFAD8;
extern char *& off_4FFBC8;
extern wchar_t* aA_1;
extern wchar_t* aJ1;
extern wchar_t* aK2;
extern wchar_t* aL3;
...
extern char* aRezGluexpcmpgn;
extern char* aLastreplay_1;
extern char* aLocal_dll;
extern __int16* word_4FFF24;
extern char* off_4FFF28;
extern char *& off_4FFF50;
extern char* aA_0;
extern CampaignMission* campaign_missions;
extern CHAR* String2;
extern char* aStareditScenar;
extern ChkSectionLoader* stru_5001CC;
extern ChkSectionLoader* stru_5001E8;
extern ChkSectionLoader* stru_5002A0;
extern ChkSectionLoader* stru_500388;
extern ChkLoader* chk_loaders;
extern ChkLoader& dword_5005D8;
extern int* dword_5008EC;
extern signed __int32& volume;
extern __int16* word_500A94;
extern __int16* word_500A96;
extern __int16* word_500AB8;
extern __int16* word_500ABA;
...
extern char* a_mpc;
extern char* a_spc;
extern char* cinematic_intros;
extern char* aLastreplay;
...
extern char* keyname;
extern bool (__fastcall ** GenericDlgInteractFxns)(dialog *dlg, struct dlgEvent *evt);
extern void (__fastcall ** GenericDlgUpdateFxns)(dialog *dlg, int x, int y, rect *dst);
extern int* dword_501544;
extern CndSignature* stru_50156C;
extern char* aReplay;
...
extern char* aGluePalpvTile_;
extern char* aGluePaltvTile_;
extern char* aGluePalzvTile_;
extern char* aGluePalpdTile_;
extern char* aGluePaltdTile_;
extern char* aGluePalzdTile_;
...
extern char* aGlueGeneric;
extern char* aGlueGamemode;
extern char* aGlueDirect;
extern char* aGlueModem;
extern char* aGlueScore;
extern char* aGlueLoad;
extern char* aGlueCreate;
extern char* aGlueGamesel;
extern char* aGlueReadyp;
extern char* aGlueReadyz;
extern char* aGlueReadyt;
extern char* aGlueCampaign;
extern char* aGlueLogin;
extern char* aGlueBattle_net_0;
extern char* aGlueChatroom;
extern char* aGlueSelconn;
extern char* aGlueSimulate;
extern char* aGlueMainmenu;
extern char* a_scm;
extern char* aStarcraftSw_78;
extern char* aRezGlumain_bin;
extern char* aStarcraftSw_77;
extern char* aStaredit_exe;
extern char* aDlgsProtoss_gr;
extern char* aDlgsTerran_grp;
extern char* aDlgsZerg_grp;
extern char* aStarcraftSw_91;
extern char* aArrMapdata_tbl;
extern char* aArrMapdata_dat;
extern char* aRezCdversion_t;
extern char* aRezDataversion;
extern char* aInvalidDataFil;
extern char* asc_501A28;
extern char* asc_501A2C;
...
extern char* aInstall_exe;
extern char* aStarcraft_mpq;
extern char* aBroodwar_mpq;
extern char* aStarcd;
...
extern char* aStarcraftSw_73;
extern char* aCrdt_exp;
extern char* aCrdt_lst;
extern char* aEpilog;
extern char* aEpilogx;
...
extern char* aFinz09bx;
extern char* aEstz10x;
extern char* aEstz09bx;
extern char* aEstz09x;
extern char* aEstz08x;
extern char* aEstz07x;
extern char* aEstz06x;
extern char* aEstz05x;
extern char* aEstz04x;
extern char* aEstz03x;
extern char* aEstz02x;
extern char* aEstz01x;
extern char* aEstt08x;
extern char* aEstt07x;
extern char* aEstt06x;
extern char* aEstt05bx;
extern char* aEstt05ax;
extern char* aEstt04x;
extern char* aEstt03x;
extern char* aEstt02x;
extern char* aEstt01x;
extern char* aEstp08x;
extern char* aEstp07x;
extern char* aEstp06x;
extern char* aEstp05x;
extern char* aEstp04x;
extern char* aEstp03x;
extern char* aEstp02x;
extern char* aEstp01x;
extern char* aEstp10;
extern char* aEstp09;
extern char* aEstp08;
extern char* aEstp07;
...
extern char* aEstt01;
extern char* aEstt0t;
extern char* aScreenlowerlef;
extern char* aScreencenter;
extern char* aScreenbottom;
extern char* aScreentop;
extern char* aScreenright;
extern char* aScreenleft;
...
extern char* aSmkXzerg_smk;
extern char* aSmkXterran_smk;
extern char* aSmkXprotoss_sm;
extern char* aSmkStarxintr_s;
extern char* aSmkProtoss4_sm;
extern char* aSmkProtoss3_sm;
extern char* aSmkProtoss2_sm;
extern char* aSmkProtoss1_sm;
extern char* aSmkPreprotoss_;
extern char* aSmkPreprotos_0;
extern char* aSmkPreprotos_1;
extern char* aSmkZerg4_smk;
extern char* aSmkZerg3_smk;
extern char* aSmkZerg2_smk;
extern char* aSmkZerg1_smk;
extern char* aSmkPrezerg_4_s;
extern char* aSmkPrezerg_3_s;
extern char* aSmkPrezerg_2_s;
extern char* aSmkTerran4_smk;
extern char* aSmkTerran3_smk;
extern char* aSmkTerran2_smk;
extern char* aSmkTerran1_smk;
extern char* aSmkPreterran_4;
extern char* aSmkPreterran_3;
extern char* aSmkPreterran_2;
extern char* aSmkPreterran_1;
extern char* aSmkStarintr_sm;
extern char* aSmkBlizzard_sm;
extern char* aStarcraftSw_69;
...
extern char* aCursor;
extern char* aScrollul_grp;
extern char* aScrolll_grp;
extern char* aScrolldl_grp;
extern char* aScrolld_grp;
extern char* aScrolldr_grp;
extern char* aScrollr_grp;
extern char* aScrollur_grp;
extern char* aScrollu_grp;
extern char* aTime_grp;
extern char* aDrag_grp;
extern char* aMagy_grp;
extern char* aMagr_grp;
extern char* aMagg_grp;
extern char* aTargn_grp;
extern char* aTargg_grp;
extern char* aTargr_grp;
extern char* aTargy_grp;
extern char* aIllegal_grp;
extern char* aArrow_grp_0;
...
extern char* a_vf4;
extern char* aSSS_0;
extern char* aTileset;
extern char* a_wpe;
extern char* aStarcraftSw_57;
extern char* aTwilight;
extern char* aIce;
extern char* aDesert;
extern char* aJungle;
extern char* aAshworld;
extern char* aInstall;
extern char* aPlatform;
extern char* aBadlands;
extern char* aArrSfxdata_tbl;
extern char* aArrSfxdata_dat;
extern char* aSoundMemoryCac;
extern char* aCreatesoundbuf;
...
extern char* aGlueReadypPf_6;
extern char* aGlueReadypPf_5;
extern char* aGlueReadypPf_4;
extern char* aGlueReadypPf_3;
extern char* aGlueReadypPf_2;
extern char* aGlueReadypPf_1;
extern char* aGlueReadypPf_0;
extern char* aGlueReadypPfra;
...
extern char* aStarcraftSw_49;
extern int& dword_50304C;
extern int& dword_503050;
extern int& dword_503054;
extern __int16& word_503058;
extern char& byte_50305A;
extern char* aRezGluload_bin;
extern char* aRezGlurdyt_bin;
extern char* asc_50307C;
extern char* aGlueReadytTf_6;
extern char* aGlueReadytTf_5;
extern char* aGlueReadytTf_4;
extern char* aGlueReadytTf_3;
extern char* aGlueReadytTf_2;
extern char* aGlueReadytTf_1;
extern char* aGlueReadytTf_0;
extern char* aGlueReadytTfra;
extern char* aRezGlurdyz_bin;
extern char* asc_50317C;
extern char* aGlueReadyzZf_6;
extern char* aGlueReadyzZf_5;
extern char* aGlueReadyzZf_4;
extern char* aGlueReadyzZf_3;
extern char* aGlueReadyzZf_2;
extern char* aGlueReadyzZf_1;
extern char* aGlueReadyzZf_0;
extern char* aGlueReadyzZfra;
extern CHAR* Name;
...
extern char* aResourcesScore;
extern char* aStructuresScor;
extern char* aUnitsScoreUPro;
extern char* aScoreOverallUU;
...
extern char* aGlueScorepv;
extern char* aGlueScorepd;
extern char* aGlueScoretv;
extern char* aGlueScoretd;
extern char* aGlueScorezv;
extern char* aGlueScorezd;
extern char* aRezGlucmpgn__0;
extern char *& off_503580;
extern char* aXprotoss;
extern char* aXzerg;
extern char* aXterran;
extern char* aProtoss;
extern char* aZerg;
extern char* aTerran;
extern char* aSS_4;
...
extern char* aRezGlucreat_bi;
extern char* aRezGlucustm_bi;
extern char* aCustomType;
...
extern char* aApsReplays;
extern int& dword_5037BC;
extern char& byte_5037C0;
extern CHAR* aAbcdefghijklmn;
extern char* aRezGlubnres_re;
extern char* aStarcraftSw_13;
extern CHAR* CursorName;
extern char* aGenericIcon_19;
extern char* aGenericIcon_18;
extern char* aGenericIcon_17;
extern char* aGenericIcon_16;
extern char* aGenericIcon_15;
extern char* aGenericIcon_14;
extern char* aGenericIcon_13;
extern char* aGenericIconsSl;
extern char* aGenericIcon_11;
extern char* aGenericIcon_10;
extern char* aGenericIcons_9;
extern char* aGenericIcons_8;
extern char* aGenericIcons_7;
extern char* aGenericIcons_6;
extern char* aGenericIcons_5;
extern char* aGenericIcons_4;
extern char* aGenericIconsCm;
...
extern char* aGenericPopupsS;
extern char* aGenericIcons_3;
extern char* aGenericIconsPr;
extern char* aGenericPopupsL;
extern char* aBackgroundsReg;
extern int& dword_503AC0;
extern int& dword_503AC4;
extern int& dword_503AC8;
extern int& dword_503ACC;
extern int& dword_503AD0;
extern char* aGenericPopup_0;
...
extern char* aIconsDisconnec;
extern char* aGenericIcons_2;
extern char* aGenericIcons_1;
extern char* aGenericIcons_0;
extern char* aGenericIconsBu;
extern char* aGenericIcon_12;
...
extern char* aBackgroundsBnl;
extern char* aBackgroundsBns;
...
extern char* aBackgroundsCha;
extern char* aBackgroundsBnc;
extern char* aBackgroundsC_0;
extern char* aBackgroundsNew;
...
extern char* aGenericPopupsH;
extern char* aBackgroundsBnj;
extern char* aBackgroundsBn_;
extern char* aTriggersCtf_tr;
extern char* aTriggersSlau_2;
extern char* aTriggersSlau_1;
extern char* aTriggersSlau_0;
extern char* aTriggersSlaugh;
extern char* aTriggersGreed1;
extern char* aTriggersGreed7;
extern char* aTriggersGreed5;
extern char* aTriggersGreed2;
extern char* aTriggersSudden;
extern char* aTriggersMelee_;
extern char* template_name;
extern char* aUnableToReadGa;
extern char* aSS_0;
extern char* aTemplates_lst;
extern char* aStarcraftSw_45;
extern char* aTemplates;
extern char* a_got;
...
extern char* a__;
extern char* aScx;
extern char* off_503EF4;
extern char* aMusicRadiofree;
extern char* aMusicTitle_wav;
extern char* aMusicPvict_wav;
extern char* aMusicTvict_wav;
extern char* aMusicZvict_wav;
extern char* aMusicPdefeat_w;
extern char* aMusicTdefeat_w;
extern char* aMusicZdefeat_w;
extern char* aMusicPrdyroom_;
extern char* aMusicTrdyroom_;
extern char* aMusicZrdyroom_;
extern char* aMusicProtoss3_;
extern char* aMusicProtoss2_;
extern char* aMusicProtoss1_;
extern char* aMusicTerran3_w;
extern char* aMusicTerran2_w;
extern char* aMusicTerran1_w;
extern char* aMusicZerg3_wav;
extern char* aMusicZerg2_wav;
extern char* aMusicZerg1_wav;
extern char* aRezMinimap_bin;
extern char* aGameTblink_pcx;
extern char* aGameBlink_grp;
...
extern char* aLeagues;
extern char* aGameresultSGam;
extern char* aS;
extern char* aNonplayer;
...
extern int (__stdcall ** off_50439C)(int);
extern char* aStarcraftSw_34;
extern char* aStarcraftSw_98;
extern char* aStarcraftSw_33;
extern char* aTheMapCouldNot;
extern char* aStarcraftSw_29;
extern char* aRezSpd_dlg_bin;
extern char* aStarcraftSw_82;
extern char* aRezVideo_bin;
extern int (__stdcall ** off_504524)(int, int, int, int);
extern int (__stdcall ** off_504528)(int, int, int, int);
...
extern char* aW;
extern char* aMsg;
extern char* aWhisper;
extern char* aUnignore;
extern char* aUnsquelch;
extern char* aIgnore;
extern char* aSquelch;
extern char* aStats;
extern char* aLeague;
...
extern FnInteract* off_504CF8;
extern const char* SupplyInfoFormat;
...
extern char* aBattle_netGate;
extern char* aStarcraftSw_23;
...
extern char* aDialog_static_;
extern char* aDialog_profile;
extern CHAR* FileName;
extern char* aWb;
extern unsigned __int8& asc_504EEC;
extern unsigned __int8& aHttp;
extern char* aTimeNewRoman;
extern char* aStarcraftSw_18;
extern char* aGlueBattle_n_3;
extern char* aPopup;
extern char* aGlueBattle_n_7;
extern char* aGlueBattle_n_6;
extern char* aAt;
extern CHAR* Format;
extern char* a0;
extern char* aArial;
extern char* aRecordSexp1Las;
extern char* aRecordSexp1L_0;
extern char* aRecordSexp1Hig;
extern char* aDynkeySexp1Ran;
extern char* aRecordSexp1H_0;
extern char* aRecordSexp1Rat;
extern char* aRecordSexp1Dis;
extern char* aRecordSexp1Los;
extern char* aRecordSexp1Win;
extern char* aRecordSexp0Las;
extern char* aRecordSexp0L_0;
extern char* aRecordSexp0Dis;
extern char* aRecordSexp0Los;
extern char* aRecordSexp0Win;
extern char* aRecordStar1Las;
extern char* aRecordStar1L_0;
extern char* aRecordStar1Hig;
extern char* aDynkeyStar1Ran;
extern char* aRecordStar1H_0;
extern char* aRecordStar1Rat;
extern char* aRecordStar1Dis;
extern char* aRecordStar1Los;
extern char* aRecordStar1Win;
extern char* aRecordStar0Las;
extern char* aRecordStar0L_0;
extern char* aRecordStar0Dis;
extern char* aRecordStar0Los;
extern char* aRecordStar0Win;
extern char* aProfileDescrip;
extern char* aProfileLocatio;
extern char* aProfileAge;
extern char* aProfileSex_1;
extern char* aDialog_creat_0;
extern char* aIcon;
extern char* aBrowse;
extern char* aGlueBattle_n_1;
extern char* aGlueBattle__17;
extern char* aGlueBattle__12;
extern char* aDialog_create_;
extern char* aBattle_html;
extern char* aLastCreatedGam;
extern char* aStarcraftSw_16;
extern char* aGlueBattle_n_5;
extern char* aGlueBattle_n_4;
extern char* aCreate;
extern char* aGlueBattle_n_2;
extern char* aStarcraftSw_15;
extern char* aGlueBattle_n_0;
extern char* aStarcraftSw_54;
extern char* aIcontable;
extern char* aGlueBattle__11;
extern char* aGlueBattle_net;
extern char* aGlueBattle__13;
extern char* aGlueBattle__14;
extern char* aGlueBattle__15;
extern char* aGlueBattle__16;
extern char* aStarcraftSw_14;
extern char* aTimesNewRoman;
...
extern char* aUsechatcolors;
extern char* aTrigtext;
extern char* aTip;
extern char* aBldgnoise;
extern char* aUnitnoise;
extern char* aUnitspeech;
extern char* aIntrox;
extern char* aIntro;
extern char* aTipnum;
extern char* aSfx;
extern char* aMusic;
extern char* aM_kscroll;
extern char* aM_mscroll;
extern char* aKscroll;
extern char* aMscroll;
extern char* aSpeed;
...
extern char* aCosh;
extern char* aSinh;
extern char* asc_509DC8;
extern __int16 ** off_509F40;
extern __int16 ** off_509F6C;
extern __int16 ** off_509FCC;
extern __int16 ** off_509FE4;
extern __int16 ** off_50A1A4;
extern __int16 ** off_50A1B8;
extern __int16 ** off_50A2E0;
...
extern int (__cdecl *&off_50C4F0)(UINT uExitCode);
extern int& dword_50C4F4;
extern int* dword_50C4F8;
extern char* off_50C4FC;
...
extern u8* byte_50CDC1;
extern int& dword_50CEC1;
...
extern int& dword_50CEE2;
extern int& dword_50CEF0;
extern int (__thiscall **&off_50CF10)(void *location, char);
extern char* a_avtype_info;
extern void *& off_50CF30;
extern char *& off_50D1B0;
extern wchar_t *& off_50D1B4;
extern int (** off_50D1B8)();
extern int (** off_50D1BC)();
extern int (** off_50D1C0)();
extern int (** off_50D1C4)();
extern int (** off_50D1C8)();
extern int (*&off_50D1CC)();
extern int& dword_50D1D0;
extern int& dword_50D1D4;
extern int& dword_50D1D8;
extern int& dword_50D1DC;
extern int& dword_50D1E0;
extern int& dword_50D1E4;
extern char* aPkwareDataCo_0;
extern int* CRC32_m_tab;
extern char& byte_50DBC8;
extern char& byte_50DBD8;
extern char& byte_50DBE8;
extern char& byte_50DBF8;
extern char* aPkwareDataComp;
extern char* aRegistration_b;
extern char ** off_50E040;
extern int& dword_50E058;
extern int& dword_50E05C;
extern int& dword_50E064;
extern char* aGluePalmm;
extern int* dword_50E170;
extern char& byte_50E174;
extern void *& off_50E176;
extern int* off_5122A0;
extern int* off_5122AC;
extern unsigned int& dword_5122B8;
extern char* byte_5122BC;
extern char* byte_5122C0;
extern char* aInternalVersio;
extern char* aRegistration_block_2;
extern char* aRegistration_table;
extern int& dword_5124D0;
extern int& FrameSkip;
extern GameSpeeds& GameSpeedModifiers;
extern UpdateFunction* update_functions;
extern RenderFunction* render_functions;
extern int& g_ActiveNationID;
extern int& dword_51267C;
extern int& dword_512680;
extern int& g_LocalNationID;
extern int& g_LocalHumanID;
extern int& playerid;
extern char ** cinematics;
extern char* byte_512700;
extern char ** off_512708;
extern __int16& word_51275C;
extern __int16* word_512768;
extern __int16& word_51276C;
extern __int16& word_512770;
extern __int16& word_512774;
extern void *& off_5127DC;
extern ActionPointer* ActionTable;
extern int& dword_5128F0;
extern ColorShiftData* colorShift;
extern char ** TileSetNames;
extern int& value;
extern int* aTenbg;
extern char* aMdomd;
extern char* aNxpif;
extern char* aNpdu;
extern char* aLbcse;
extern swishTimer& stru_512A00;
extern swishTimer* stru_512A14;
extern swishTimer& stru_512A34;
extern swishTimer& stru_512A48;
extern swishTimer* stru_512A54;
extern swishTimer* stru_512A70;
extern swishTimer& stru_512A8C;
extern char ** off_512A98;
extern int* dword_512AB0;
extern int* dword_512AC8;
extern int* dword_512AE0;
extern swishTimer* gluCmpgnSwishController;
extern char* aRegistration_block;
extern __int16& word_512B98;
extern DatLoad* mapdataDat;
extern int* dword_512BB8;
extern char* byte_512BBC;
extern char* byte_512BBD;
extern char* byte_512BBE;
extern char* aRegistration_block_1;
extern RECT& stru_512D00;
extern int* dword_512D20;
extern POINT& AngleDistance;
extern int* tangent_table;
extern int& off_513628;
extern __int16* word_513634;
extern int* dword_513650;
extern int* dword_513654;
extern int& dword_5136C8;
extern RECT& stru_5136CC;
extern DatLoad* upgradesDat;
extern DatLoad* portdataDat;
extern DWORD& ColorCycle;
extern DatLoad* techdataDat;
extern DatLoad* weaponsDat;
extern char* aRegistration_block_0;
extern SightStruct* line_of_sight;
extern ScrollSpeeds& scrollSpeeds;
extern char& byte_513B92;
extern __int16* unknown_campaign_related;
extern char* byte_513C24;
extern DatLoad* unitsDat;
extern DatLoad* ordersDat;
extern DatLoad* spritesDat;
extern DatLoad* imagesDat;
extern char& byte_5140C4;
extern char& byte_5140D8;
extern char& byte_5140E8;
extern char* byte_514108;
extern char* byte_51410C;
extern char ** ReservedDosFilenames;
extern __int16* word_514178;
extern __int16* word_51417A;
...
extern DWORD& UnitPortraits;
extern char* byte_515228;
extern char* byte_515280;
extern char* byte_515281;
extern char* byte_515290;
extern char* byte_515291;
extern char* byte_515292;
extern char* byte_515293;
extern void *& off_5153E8;
extern int& dword_5153F8;
extern int (__stdcall *&off_5153FC)(int, int, int);
extern int* dword_515418;
extern int* dword_51541C;
extern DatLoad* sfxdataDat;
extern char* aProfileSex_0;
extern char* aProfileAge_0;
extern char* aProfileLocat_0;
extern char* aProfileDescr_0;
extern char* aRecordStar0W_0;
extern char* aRecordStar0L_1;
extern char* aRecordStar0D_0;
extern char* aRecordStar0L_2;
extern char* aRecordStar0L_3;
extern char* aRecordStar1W_0;
extern char* aRecordStar1L_1;
extern char* aRecordStar1D_0;
extern char* aRecordStar1R_0;
extern char* aRecordStar1H_1;
extern char* aDynkeyStar1R_0;
extern char* aRecordStar1H_2;
extern char* aRecordStar1L_2;
extern char* aRecordStar1L_3;
extern char* aProfileSex;
extern char* aProfileAge_1;
extern char* aProfileLocat_1;
extern char* aProfileDescr_1;
extern char* aRecordSexp0W_0;
extern char* aRecordSexp0L_1;
extern char* aRecordSexp0D_0;
extern char* aRecordSexp0L_2;
extern char* aRecordSexp0L_3;
extern char* aRecordSexp1W_0;
extern char* aRecordSexp1L_1;
extern char* aRecordSexp1D_0;
extern char* aRecordSexp1R_0;
extern char* aRecordSexp1H_1;
extern char* aDynkeySexp1R_0;
extern char* aRecordSexp1H_2;
extern char* aRecordSexp1L_2;
extern char* aRecordSexp1L_3;
extern int& dword_5159A4;
extern char ** off_5159A8;
extern char* aOk_dialog;
extern char* aBigok_dialog;
extern char* aOkcancel_dialo;
extern char* aBigokcancel_dialog;
extern DatLoad* flingyDat;
extern int (** off_515A98)();
...
extern int& dword_51A208;
extern void *& off_51A20C;
extern int& dword_51A210;
extern int& dword_51A214;
extern void *& off_51A218;
extern int& dword_51A21C;
extern void *& off_51A224;
extern int& dword_51A228;
extern void *& off_51A230;
extern void *& dword_51A234;
extern int& dword_51A238;
extern void *& off_51A23C;
extern int& dword_51A240;
extern void *& off_51A248;
extern int& dword_51A24C;
extern int& dword_51A250;
extern void *& off_51A254;
extern int& dword_51A258;
extern void *& off_51A260;
extern int& dword_51A264;
extern void *& off_51A26C;
extern int& dword_51A270;
extern int& MapListVector;
extern void *& off_51A278;
extern int& dword_51A27C;
extern TriggerList* TriggerVectors;
extern int& dword_51A2E0;
extern void *& off_51A2E4;
extern int& dword_51A2E8;
extern int& dword_51A2EC;
extern void *& off_51A2F0;
extern int& dword_51A2F4;
extern int& dword_51A2F8;
extern void *& off_51A2FC;
extern int& dword_51A300;
extern int& dword_51A304;
extern void *& off_51A308;
extern TriggerList& stru_51A310;
extern int& dword_51A31C;
extern void *& off_51A320;
extern int& dword_51A324;
extern int& dword_51A328;
extern void *& off_51A32C;
...
extern FnInteract* off_51A358;
extern int (__thiscall **&off_51A368)(void *location, char);
extern char* a_au_hiddenctrl;
extern FnInteract* off_51A388;
extern int (__thiscall **&off_51A3B8)(void *location, char);
extern char* a_autgame_hdr_node;
extern int (__thiscall **&off_51A3E4)(void *location, char);
extern char* a_autsaved_game_node;
extern FnInteract* off_51A404;
extern int (__thiscall **&off_51A424)(void *location, char);
extern char* a_austreamed;
extern int (__thiscall **&off_51A440)(void *location, char);
extern char* a_autprovider;
extern int (__thiscall **&off_51A458)(void *location, char);
extern char* a_au_id;
extern FnInteract* off_51A46C;
extern swishTimer* gluChatSwishController;
extern FnInteract* off_51A4A8;
extern FnInteract* off_51A5F8;
extern int (__thiscall **&off_51A648)(void *location, char);
extern char* a_au_gamenode;
extern FnInteract* off_51A660;
extern FnInteract* off_51A69C;
extern FnInteract* off_51A6B8;
extern FnInteract* off_51A6CC;
extern FnInteract* off_51A6DC;
extern FnInteract* off_51A6E4;
extern FnInteract* off_51A6F0;
extern char* separators2_maybe;
extern int (__thiscall **&off_51A71C)(void *location, char);
extern char* a_au_savegame;
extern FnInteract* off_51A734;
extern FnInteract* off_51A750;
extern FnInteract* off_51A7A0;
extern FnInteract* off_51A7F0;
extern FnInteract* off_51A804;
extern FnInteract* off_51A80C;
extern FnInteract* off_51A818;
extern FnInteract* off_51A848;
extern FnInteract* off_51A93C;
extern int (__thiscall **&off_51A968)(void *location, char);
extern char* a_au_phonenumber;
extern int (__thiscall **&off_51A984)(void *location, char);
extern char* a_au_device;
extern swishTimer* stru_51A99C;
extern FnInteract* off_51A9AC;
extern char* separators_maybe;
extern swishTimer* gluCustmSwishController;
extern FnInteract* off_51AA08;
extern int& dword_51AAA0;
extern int& dword_51AAA8;
extern int (__thiscall **&off_51AAB0)(void *location, char);
extern char* a_au_drawtext;
extern int (__thiscall **&off_51AAC8)(void *location, char);
extern char* a_auttemplate;
extern int (__thiscall **&off_51AAE0)(void *location, char);
extern char* a_aulistentry;
extern FnInteract& off_51AAF8;
extern FnInteract* off_51AAFC;
extern FnInteract* off_51AB0C;
extern FnInteract* off_51AB20;
extern int (__thiscall **&off_51AB94)(void *location, char);
extern char* a_autriggernode;
extern FnInteract* off_51ABB0;
extern FnInteract* off_51ABC0;
extern int (__thiscall **&off_51ABD4)(void *location, char);
extern char* a_autbnetmessage;
extern FnInteract* a3;
extern int* dword_51ABFC;
extern int (__thiscall **&off_51AC10)(void *location, char);
extern char* a_autfd_session;
extern int (__thiscall **&off_51AC2C)(void *location, char);
extern char* a_autuser_info;
extern int (__thiscall **&off_51AC48)(void *location, char);
extern char* a_autban;
extern int (__thiscall **&off_51AC5C)(void *location, char);
extern char* a_autsavegame;
extern FnInteract* off_51AC74;
extern FnInteract* off_51AC84;
extern FnInteract& off_51AC90;
extern FnInteract& off_51AC94;
extern FnInteract* off_51AC98;
extern int& dword_51ACB0;
extern int& dword_51ACB4;
extern int& dword_51ACB8;
extern int& dword_51ACC0;
extern char* aEntrextrdwhepb;
extern int (__thiscall **&off_51AD18)(void *location, char);
extern char* a_autfd_user;
extern FnInteract* off_51AD30;
...
extern int& id;
extern char ** off_51AE94;
extern char ** off_51AE98;
extern char ** off_51AE9C;
extern char *& off_51AEA0;
extern int& nNumber;
extern char *& off_51AEA8;
extern char* a_xxx_xxxxxxxxx;
extern char* a___xxx____xxxx;
...
extern int (__thiscall **&off_51B274)(void *location, char);
extern HANDLE& hObject;
extern int& dword_51B294;
extern int (__thiscall **&off_51B298)(void *location, char);
extern char* a_au_bltmask;
extern int (__thiscall **&off_51B2B0)(void *location, char);
extern char* a_au_ctrlnode;
extern int& dword_51B2C8;
extern char& byte_51B2CC;
extern char& byte_51B2CD;
extern char& byte_51B2CE;
extern char& byte_51B2CF;
extern int (__thiscall **&off_51B2D0)(void *location, char);
extern char* a_au_dlggrp;
extern int& dword_51B2E8;
extern int& dword_51B2F0;
extern int& dword_51B2F4;
extern int& dword_51B2F8;
extern int (__thiscall **&off_51B428)(void *location, char);
extern char* a_auchunknode;
extern char* aUs;
extern char* aSs;
extern int (__cdecl *&off_51B448)(_DWORD);
extern int (** off_51B44C)();
...
extern int (__stdcall *&dword_51BD68)(_DWORD, _DWORD, _DWORD, _DWORD);
extern int (*&dword_51BD6C)(void);
extern int (__stdcall *&dword_51BD70)(_DWORD);
extern int (*&dword_51BD74)(void);
extern int (__stdcall *&dword_51BD78)(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD);
...
extern char& byte_51BFB8;
extern char* byte_51BFB9;
...
extern int& Ophelia;
extern Bitmap* stru_51C000;
extern void *& dword_51C408;
extern void *& dword_51C40C;
extern MapData4& NextCampaign;
...
extern unsigned int& dword_51CA10;
extern int& LastRandomNumber;
extern int& dword_51CA18;
extern int& dword_51CA1C;
extern char* byte_51CA20;
extern HANDLE& dword_51CC28;
extern HANDLE& dword_51CC2C;
extern void *& dword_51CC30;
extern HANDLE& hMpq;
extern HANDLE& dword_51CC38;
...
extern char* byte_5240D0;
extern CImage* stru_5244B8;
...
extern char* curPlayerID;
extern char* byte_57F098;
extern char* byte_57F09A;
extern int& dword_57F0B0;
extern int* OpheliaCheat2;
extern int* playerStatusArray;
...
extern int& MoveToTile;
extern MapSize& map_size;
extern __int16& word_57F1D8;
extern __int16& SendTextFilter;
extern Tileset& CurrentTileSet;
extern __int16& word_57F1DE;
extern char& byte_57F1E1;
extern char& byte_57F1E2;
extern char& byte_57F1E3;
extern int* PlayerVision;
extern int* dword_57F21C;
extern int& dword_57F220;
extern int& dword_57F224;
extern int& dword_57F228;
extern int& dword_57F22C;
extern int& dword_57F230;
extern int& dword_57F234;
extern int& dword_57F238;
extern int& ElapsedTimeFrames;
extern int& dword_57F240;
extern MapData& CampaignIndex;
extern char* byte_57F246;
extern int& dword_57F24A;
extern int& dword_57F24E;
extern int& dword_57F252;
extern int& dword_57F256;
extern int& dword_57F25A;
extern int& dword_57F25E;
extern int& dword_57F262;
extern char& byte_57F266;
extern int& dword_57F267;
extern int& dword_57F26B;
extern __int16& word_57F270;
extern __int16& word_57F272;
extern UnitAvail& UnitAvailability;
extern char& byte_57FD2C;
extern int& dword_57FD34;
extern int& dword_57FD38;
extern char* CurrentMapFileName;
extern char* CurrentMapName;
extern int* dword_57FE60;
extern char& byte_581D60;
extern char& byte_581D61;
extern char* byte_581D62;
extern char& byte_581D64;
extern char& byte_581D65;
extern char& byte_581D66;
extern char& byte_581D68;
extern char& byte_581D69;
extern char* byte_581D6A;
extern char& byte_581D75;
extern int* dword_581D76;
extern int* dword_581D7A;
extern char* byte_581DD5;
extern u8* PlayerColors;
extern AllScoresStruct& AllScores;
extern TechSC* TechAvailableSC;
extern TechSC* TechResearchSC;
extern UpgradesSC* UpgradeMaxSC;
extern UpgradesSC* UpgradeLevelSC;
...
extern PlayerAlliance* Alliance;
extern int* MissionObjectives;
...
extern Position* startPositions;
extern int* TriggerSwitches;
extern Location* LocationTable;
extern char* byte_58F038;
extern int& TimerIsPaused;
extern TechBW* TechAvailableBW;
extern TechBW* TechResearchBW;
extern u8* ResearchProgress;
extern UpgradesBW* UpgradeMaxBW;
extern UpgradesBW* UpgradeLevelBW;
extern u8* UpgradeProgress;
extern char& IsExpansion;
extern int& dword_58F442;
extern int& dword_58F446;
extern int& dword_5967F0;
extern struct_game_140& stru_5967F8;
extern int& dword_596888;
extern int& NetMode;
extern int& dword_596890;
extern char& byte_596894;
extern HACCEL& dword_596898;
extern InputProcedure* input_procedures;
extern int& dword_5968EC;
extern HACCEL& hAccel;
extern HACCEL& dword_5968F4;
extern HACCEL& dword_5968F8;
extern InputProcedure& dword_5968FC;
extern GamePosition& gwGameMode;
extern char* byte_596910;
extern int& dword_596A14;
extern char* byte_596A18;
extern char& byte_596A20;
extern char& Game_KeyStateSomething;
extern char& byte_596A29;
extern char& byte_596A2A;
extern char& byte_596A39;
extern char& byte_596A3A;
extern char& byte_596A3B;
extern char& byte_596A3C;
extern char& byte_596A3D;
extern char& byte_596A3E;
extern char& byte_596A3F;
extern char& byte_596A40;
extern char& byte_596A78;
extern char& byte_596A79;
extern char& byte_596A7A;
extern char& byte_596A7B;
extern char& byte_596A7C;
extern char& byte_596A7D;
extern char& byte_596A7E;
extern char& byte_596A7F;
extern char& byte_596A80;
extern char& byte_596A81;
extern dialog *& dlg;
extern int* dword_596B20;
extern int& dword_596B24;
extern int& dword_596B44;
extern int& dword_596B48;
extern int& dword_596B6C;
extern int& dword_596B70;
extern int& dword_596B74;
...
extern void *& dword_596BBC;
extern HANDLE& hArchive;
extern char& byte_596BC8;
extern int& dword_596CCC;
extern void *& dword_596CD0;
extern int& dword_596CD4;
extern int& dword_5971D8;
extern int& dword_5971DC;
extern int& dword_5971E0;
extern int* dword_5971E4;
extern int& dword_5971E8;
extern int& dword_5971EC;
extern int& dword_5971F0;
extern int& dword_5971F4;
extern int& dword_5971F8;
extern int& dword_5971FC;
extern int& dword_597200;
extern int& dword_597204;
extern CUnit ** ClientSelectionGroup;
...
extern int* palette;
extern __int16& word_5998E0;
extern DWORD& ThreadId;
extern int& dword_5998E8;
extern struct_6* stru_5998F0;
...
extern int& dword_59B838;
extern int& dword_59B83C;
extern int& dword_59B840;
extern int& dword_59B844;
extern int& dword_59B848;
extern char* menuMapRelativePath;
extern char* byte_59B958;
extern int& dword_59BA5C;
extern void *& dword_59BA60;
extern int& dword_59BA64;
extern char* byte_59BA68;
extern char& byte_59BB6C;
extern char* CurrentMapFolder;
extern dialog *& dword_59BC74;
extern dialog *& dword_59BC7C;
extern int& dword_59BC80;
extern char* menuMapFileName;
...
extern int& dword_59BDA8;
extern int& dword_59BDAC;
extern PlayerInfo* LobbyPlayers;
extern int* dword_59BF60;
extern int* dword_59BF64;
extern int& dword_59BF6C;
extern int* dword_59BF70;
extern char* byte_59BF78;
extern char ** MapdataFilenames;
extern __int16& word_59C184;
extern int (*&dword_59C188)(void);
extern int& dword_59C18C;
extern void *& dword_59C190;
extern Bitmap& minimap_related_maybe;
extern __int16& word_59C19C;
extern int (*&dword_59C1A0)(void);
extern dialog *& dword_59C1A4;
extern int& dword_59C1A8;
extern void *& dword_59C1AC;
extern __int16& word_59C1B0;
extern char* byte_59C1B8;
extern int* dword_59C1BC;
extern int* dword_59C1C0;
extern __int16* word_59C1C4;
extern char* byte_59C1C6;
extern int& dword_59C2B8;
extern char* byte_59C2C0;
extern char& byte_59C3C0;
extern char& byte_59C4C0;
extern char& byte_59C5C0;
extern int* dword_59CAC0;
extern int* dword_59CAC4;
extern bool& HasMegatileUpdate;
extern dialog *& dword_59CB5C;
extern char* byte_59CB60;
extern int* dword_59CB64;
extern dialog *& dword_59CC60;
extern int& dword_59CC64;
extern __int16& word_59CC68;
extern __int16& word_59CC6C;
extern __int16& word_59CC70;
extern int& dword_59CC74;
extern int& dword_59CC78;
extern int& dword_59CC7C;
extern int& dword_59CC80;
extern int& dword_59CC84;
extern int& dword_59CC88;
...
extern int* dword_59CCA0;
extern int& dword_59CCA4;
extern CUnit* UnitNodeTable;
...
extern CUnit ** UnitNodeList_PlayerFirstUnit;
...
extern int& MoveToX;
extern int& dword_628490;
extern int *& CellMap;
extern int& dword_628498;
extern int& dword_62849C;
extern __int16& move_area;
extern __int16& word_6284A2;
extern __int16& word_6284A4;
extern __int16& word_6284A6;
extern int& MoveToY;
extern int& dword_6284AC;
extern int& dword_6284B0;
extern int& selectionIndexStart;
extern CUnit ** PlayerSelection;
extern int* dword_6284E8;
extern char& byte_628668;
extern char& byte_629268;
extern int* dword_629284;
extern SpriteTileData& SpritesOnTileRow;
extern char* byte_629A88;
extern char* byte_629C90;
extern int& dword_629D90;
extern CSprite* SpriteTable;
...
extern __int16* word_63FF78;
extern __int16* word_6402B8;
extern int& dword_640548;
extern __int16* word_640550;
...
extern int& dword_640884;
extern __int16* word_640888;
extern UnitType& word_64088A;
extern char& byte_64088C;
extern char& byte_64088D;
extern int& dword_640890;
extern char* byte_640898;
extern char* byte_6408F8;
extern int& dword_640958;
extern __int16* word_64095C;
extern char* algn_64095E;
extern int& dword_64096C;
extern char* byte_64097A;
extern char* byte_64097B;
extern int& Chat_IncrementY;
extern int* dword_640B24;
extern int& dword_640B54;
extern u8& Chat_NextLine;
extern Chat_TextLine* Chat_GameText;
extern u8* Chat_ColorBytes;
extern char* byte_641684;
extern char& byte_641691;
extern char& byte_641692;
extern char& byte_641693;
extern char& byte_641694;
extern int& dword_641698;
extern COrder *& dword_64B2E0;
extern COrder *& dword_64B2E4;
extern CBullet* BulletNodeTable;
extern int& dword_64DEA8;
extern CBullet *& BulletNodeTable_unknown;
extern CUnit *& dword_64DEB0;
extern int& unknown_air_splash_related_unit_count;
extern int& dword_64DEB8;
extern int& dword_64DEBC;
...
extern CUnit *& dword_64EECC;
extern int& dword_64EED0;
extern int& dword_64EED4;
extern CBullet *& dword_64EED8;
extern CBullet *& dword_64EEDC;
extern CUnit& stru_64EEE0;
extern CThingy *& ThingyList_UsedFirst;
extern CThingy *& dword_65291C;
extern bool& wantThingyUpdate;
extern CThingy* stru_652928;
extern int& dword_654868;
extern int& dword_65486C;
extern CThingy *& dword_654870;
extern CThingy *& dword_654874;
extern CThingy *& dword_654878;
extern CThingy *& dword_65487C;
extern char* TurnBuffer;
...
extern int* dword_654AA8;
extern int& dword_6552A8;
extern char& byte_6554B0;
extern int* arraydata;
extern char* byte_6554D8;
...
extern void (__thiscall *&dword_6556F0)(dlgEvent *);
extern int& dword_6556F4;
extern int& dword_6556F8;
extern __int16& word_6556FC;
extern char* Upgrade_MaxRepeats;
extern __int16* Upgrade_MineralCostBase;
extern __int16* Upgrade_GasCostFactor;
extern __int16* Upgrade_GasCostBase;
extern __int16* Upgrade_Unknown;
extern __int16* Upgrade_TimeCostFactor;
extern __int16* Upgrade_MineralCostFactor;
extern __int16* Upgrade_Label;
extern __int16* Upgrade_Icon;
extern char* Upgrade_IsBroodWarPnly;
extern __int16* Upgrade_TimeCostBase;
extern char* Upgrade_Race;
...
extern int* dword_655C58;
extern char* byte_655E10;
extern int* dword_655E80;
extern char* byte_656038;
extern char* byte_6560A8;
extern char* byte_656118;
extern int& dword_656188;
extern int& dword_65618C;
extern int& dword_656190;
extern __int16* Tech_Unknown;
extern __int16* Tech_GasCost;
extern __int16* Tech_MineralCost;
extern __int16* Tech_LabelIndex;
extern __int16* Tech_Unknown2;
extern __int16* Tech_EnergyCost;
extern __int16* Tech_ResearchTime;
extern __int16* Tech_Icon;
extern u8* Weapon_DamageFactor;
extern u16* Weapon_TargetErrorMessage;
extern WeaponBehavior* Weapon_Behavior;
extern char* Weapon_ExplosionType;
extern u16* Weapon_Icon;
extern __int16* Weapon_InnerSplashRadius;
extern u8* Weapon_AttackDirection;
extern int* Weapon_MinRange;
extern u8* Weapon_YOffset;
extern int* Weapon_Graphic;
extern u16* Weapon_DamageAmount;
extern u8* Weapon_DamageCooldown;
extern char* Weapon_RemoveAfter;
extern __int16* Weapon_MedianSplashRadius;
extern char* Weapon_Upgrade;
extern DamageType* Weapon_DamageType;
extern __int16* Weapon_Label;
extern char* Weapon_TechHint;
extern int* Weapon_MaxRange;
extern __int16* Weapon_DamageBonus;
extern u16* Weapon_OuterSplashRadius;
extern u8* Weapon_LaunchSpin;
extern u8* Weapon_XOffset;
extern WeaponTargetFlags* Weapon_TargetFlags;
extern char& byte_657A9C;
extern int* dword_657AA0;
...
extern int* dword_658AC4;
extern int& dword_658AC8;
extern int& dword_658ACC;
extern int& dword_658AD0;
extern void *& dword_658AD8;
...
extern u8* Unit_MaxAirHits;
extern u16* Unit_GasCost;
extern u8* Unit_ArmorAmount;
extern char* byte_65FFAC;
extern u16* Unit_FirstWhatSound;
extern u8* Unit_AIInterval;
extern u16* Unit_MapStringID;
extern u16* Unit_TimeCost;
extern u8* Unit_Direction;
extern u8* Unit_BroodwarOnly;
extern __int16* Unit_SubUnit;
extern u8* Unit_SpaceProvided;
extern u16* Unit_MaxShieldPoints;
extern __int16& word_660E92;
extern u8* Unit_ConstructionGraphics;
extern u16* Unit_LastYesSound;
extern u16* Unit_AvailabilityFlags;
extern WeaponType* Unit_AirWeapon;
extern UnitDimentions* Unit_Dimensions;
extern u16* Unit_LastAnnoyedSound;
extern u16* Unit_ReadySound;
extern u8* Unit_RightClickAction;
extern u8* Unit_SizeType;
extern Order* Unit_HumanAiIdleOrder;
extern u32* Unit_MaxHitPoints;
extern u16* Unit_AddonOffset;
extern u32* Unit_Placement;
extern u16* Unit_LastWhatSound;
extern u8* Unit_SeekRange;
extern Order* Unit_ComputerAiIdleOrder;
extern u16* Unit_IdlePortrait;
extern u8* Unit_Elevation;
extern u8* Unit_SightRange;
extern Order* Unit_AttackUnitOrder;
extern char& byte_663325;
extern char& byte_66333E;
extern char& byte_66333F;
extern char& byte_663369;
extern char& byte_663375;
extern u16* Unit_BuildScore;
extern u8* Unit_ArmorUpgrade;
extern WeaponType* Unit_GroundWeapon;
extern u8* Unit_GroupFlags;
extern u16* Unit_MineralCost;
extern u8* Unit_AttackMoveOrder;
extern u16* Unit_FirstAnnoyedSound;
extern u16* Unit_FirstYesSound;
extern u8* Unit_SupplyRequired;
extern u8* Unit_SubLabel;
extern u16* Unit_DestroyScore;
extern UnitPrototypeFlags* Unit_PrototypeFlags;
extern u8* Unit_SpaceRequired;
extern FlingyID* Unit_Graphic;
extern u8* Unit_MaxGroundHits;
extern u8* Unit_SupplyProvided;
extern u8* Unit_ShieldsEnabled;
extern Order* Unit_ReturnToIdleOrder;
extern u16* Units_InfestChangeUnit;
extern char* Orders_Unknown4;
extern char* Orders_UseWeaponTargeting;
extern char* Orders_Unused12;
extern char* Orders_Unknown11;
extern char* Orders_IscriptAnimation;
extern Tech* Orders_TechUsed;
extern __int16* Orders_HilightedIcon;
extern char* Orders_CanBeInterrupted;
extern char* Orders_Unknown7;
extern char* Orders_Unknown9;
extern __int16* Orders_Label;
extern char* Orders_ObscuredOrder;
extern char* Orders_CanBeObstructed;
extern __int16* Orders_Unknown17;
extern char* Orders_CanBeQueued;
extern char* Orders_Unused5;
extern WeaponType* Orders_TargetingWeapon;
extern char* Orders_Unused2;
extern char* Orders_Unused3;
extern char* Sprites_IsVisible;
extern char* byte_665DCE;
extern char* byte_665F56;
extern unsigned __int16* Sprites_Image;
extern int* Images_LandingDustLO;
extern u8* Image_DrawIfCloaked;
extern int* Images_SpecialOverlayLO;
extern int* Images_GrpFile;
extern u8* Images_Remapping;
extern u8* Image_DrawFunction;
extern int* Images_InjuryOverlayLO;
extern int* Images_AttackOverlayLO;
extern u8* Images_IsClickable;
extern int* Images_ShieldOverlayLO;
extern u8* Images_UseFullIscript;
extern int* Images_LiftOffDustLO;
extern u8* Images_IsTurnable;
extern int* Images_IscriptEntry;
extern char* byte_66FBE4;
extern char& byte_66FBF6;
extern char& byte_66FBF7;
extern char& byte_66FBF8;
extern char& byte_66FBF9;
extern char& byte_66FBFA;
extern int& dword_66FBFC;
extern int& dword_66FC00;
extern char* byte_66FC08;
extern char* byte_66FD10;
extern char& byte_66FE14;
extern int& dword_66FE18;
extern char& byte_66FE1C;
extern char* byte_66FE20;
extern __int16* word_66FE22;
extern __int16* word_66FE24;
extern __int16* word_66FE26;
...
extern int& dword_66FF50;
extern int& dword_66FF54;
...
extern UnitFinderData* UnitOrderingX;
extern UnitFinderData* UnitOrderingY;
...
extern void *& dword_68C1E0;
extern char& byte_68C1E4;
extern char& byte_68C1E5;
extern dialog *& dword_68C1E8;
extern int& dword_68C1EC;
extern dialog *& dword_68C1F0;
...
extern char* buffer;
extern char& byte_68C20A;
extern dialog *& dword_68C220;
extern dialog *& dword_68C224;
extern char& byte_68C228;
extern int& dword_68C22C;
extern int& dword_68C230;
extern dialog *& dword_68C234;
extern void *& dword_68C238;
extern char* byte_68C23C;
extern char* byte_68C240;
...
extern char* SFXData_MuteVolume;
extern char* SFXData_Flags2;
extern __int16* SFXData_Race;
extern char* SFXData_Flags1;
extern char ** SFXData_SoundFile;
extern dialog *& dword_68EC80;
extern void *& dword_68EC84;
extern void *& dword_68EC88;
extern int& dword_68EC90;
extern int& dword_68EC94;
extern int& dword_68EC98;
extern int& dword_68EC9C;
extern UnknownPlayerRelated* stru_68ECB0;
extern int& dword_68F4F0;
extern int& dword_68F4F4;
extern int& dword_68F4F8;
extern int* PlayerDownloadStatus;
...
extern int* dword_6BB210;
extern int* dword_6BB59C;
extern int* dword_6BB5A0;
extern int& MaxUnitHeight;
extern int* dword_6BD3D0;
extern int& dword_6BEE64;
extern int& MaxUnitWidth;
extern int* dword_6BEE6C;
extern int* dword_6BEE70;
...
extern u8* Flingy_MovementControl;
extern u32* Flingy_HaltDistance;
extern u16* Flingy_Acceleration;
extern u8* Flingy_TurnSpeed;
extern u32* Flingy_TopSpeed;
extern u8* Flingy_Unused;
extern u16* Flingy_SpriteID;
extern int* AiSupplyReserved;
extern int* dword_6CA4EC;
extern int* dword_6CA51C;
extern void *& dword_6CA54C;
extern int& dword_6CA550;
...
extern char* byte_6CA668;
extern char* byte_6CA76C;
extern char* byte_6CA7A0;
extern char* byte_6CA818;
extern char* byte_6CA91C;
extern int& dword_6CA93C;
extern __int16& word_6CA940;
extern int* dword_6CA94C;
extern int* dword_6CA950;
extern int* dword_6CA954;
extern int* dword_6CA958;
extern int* dword_6CA95C;
extern int* dword_6CA960;
extern char* byte_6CA988;
extern int& dword_6CA9EC;
extern char& byte_6CA9F0;
extern char* byte_6CA9F8;
extern char* byte_6CAB08;
extern __int16& word_6CAC0C;
extern char& byte_6CAC10;
extern char* byte_6CAC78;
...
extern int& main_thread_id_maybe;
extern int& GameSpeed;
extern int& MouseScrollSpeed;
extern int& KeyScrollSpeed;
extern int& dword_6CDFE0;
extern int& dword_6CDFE4;
extern int& dword_6CDFE8;
extern int& dword_6CDFEC;
extern int& dword_6CDFF0;
extern int& dword_6CDFF4;
extern char& byte_6CDFF8;
...
extern Font ** FontBase;
extern char& byte_6CE104;
extern int& PrintXY_PositionX;
extern int& dword_6CE10C;
extern char& PrintXY_Size;
extern char& byte_6CE111;
extern char& byte_6CE2A0;
extern char* byte_6CE31C;
extern char* byte_6CE31D;
extern char* byte_6CE31E;
extern PALETTEENTRY* GamePalette;
extern PALETTEENTRY* stru_6CE720;
...
extern dialog *& dword_6D0538;
extern void *& dword_6D053C;
...
extern char* byte_6D0E88;
extern int& dword_6D0F08;
extern int& dword_6D0F0C;
extern int& dword_6D0F10;
extern dlgEvent *& InReplay;
extern int& ReplayVision;
extern int& ReplayRevealAll;
extern int& dword_6D0F20;
extern void *& dword_6D0F24;
extern dialog *& dword_6D0F28;
extern int& dword_6D0F2C;
extern char& byte_6D0F30;
extern int& ReplayFrames;
extern MapData& word_6D0F35;
extern int& dword_6D0F37;
extern int& dword_6D0F3B;
extern int& dword_6D0F3F;
extern char& byte_6D0F43;
extern char& byte_6D0F69;
extern char& byte_6D0F6A;
extern char& byte_6D0F76;
extern int& dword_6D1181;
extern int& dword_6D1185;
extern int& dword_6D1189;
extern int& dword_6D118D;
extern int& dword_6D1191;
extern int& dword_6D1195;
extern int& dword_6D1199;
extern int& dword_6D119D;
extern int& dword_6D11A1;
extern int& dword_6D11A5;
extern int& dword_6D11AC;
extern int& dword_6D11B0;
...
extern StatusFlags& dword_6D1200;
extern int& dword_6D1204;
extern int (*&dword_6D1208)(void);
extern HACCEL& hAccTable;
extern int& dword_6D1210;
extern char& byte_6D1214;
extern FILE *& dword_6D1218;
extern char& byte_6D121C;
extern WORD *& dword_6D1220;
...
extern char& byte_6D5A10;
extern int& dword_6D5A14;
extern void *& dword_6D5A18;
extern void *& dword_6D5A1C;
extern int& dword_6D5A20;
extern dialog *& dword_6D5A24;
extern int& dword_6D5A28;
extern int& dword_6D5A2C;
extern dialog *& dword_6D5A30;
extern int& dword_6D5A38;
extern dialog *& dword_6D5A3C;
extern FnInteract *& dword_6D5A40;
extern void *& dword_6D5A44;
extern int& dword_6D5A48;
extern int& dword_6D5A4C;
...
extern int& dword_6D5A64;
extern int& dword_6D5A68;
...
extern int& dword_6D5C20;
extern CUnit *& dword_6D5C24;
extern int& dword_6D5C28;
extern UINT_PTR& uIDEvent;
extern int* dword_6D5C30;
extern int* dword_6D5C50;
extern void *& dword_6D5C70;
extern void *& dword_6D5C74;
...
extern dialog ** EventDialogs;
extern struct_0* stru_6D5E8C;
extern int (__stdcall *&dword_6D5EAC)(_DWORD);
extern dialog *& dword_6D5EB0;
extern int& dword_6D5EB4;
extern int& dword_6D5EB8;
extern void *& dword_6D5EBC;
extern void *& dword_6D5EC0;
...
extern int& dword_6D6380;
extern HINSTANCE& dword_6D6384;
extern int& dword_6D6388;
extern char& byte_6D638C;
extern SfxData& dword_6D6390;
extern char& byte_6D6394;
...
extern int& dword_6D642C;
extern int& dword_6D6430;
extern int& dword_6D6434;
...
extern char* byte_6DB180;
extern Bitmap& stru_6DB284;
extern Bitmap& stru_6DB28C;
extern char* byte_6DB298;
extern char* byte_6DB698;
extern char* byte_6DB718;
extern char* byte_6DB818;
extern char* byte_6DB898;
extern char& byte_6DB918;
extern char& byte_6DBD18;
extern char* byte_6DBD38;
extern char* byte_6DBD60;
extern char& byte_6DBE60;
extern char& byte_6DC260;
extern char* byte_6DC280;
