...
extern int (__fastcall*gndSightCB_Inside)(int, int, SightStruct *, MegatileFlags *, unsigned int, unsigned int);
extern int (__stdcall*airSightCB_Edge)(int, int, int, int);
extern int (__fastcall*airSightCB_Inside)(int, int, SightStruct *, MegatileFlags *, unsigned int, unsigned int);
...
extern int(*MinimapControl_ShowAllianceDialog)();
...
extern int(*Minimap_TimerRefresh)();
...
int getNameFromPath(char *out_buf, const char *path, size_t size);
...
extern char* aFeb;
extern char* aJan;
extern char* aSaturday;
extern char* aFriday;
extern char* aThursday;
extern char* aWednesday;
extern char* aTuesday;
extern char* aMonday;
extern char* aSunday;
extern char* aSat;
extern char* aFri;
...
extern int (__stdcall ** funcs_455F96)(int, int, int);
...
extern int* damage_type_multiplier[5];
...
extern void *& network_device_list_maybe;
...
extern void *& map_directory_list_end;
extern MapDirEntry *& map_drectory_list_begin;
...
extern int& Ophelia;
extern Bitmap* glue_background_palette;
...
extern char* building_overlay_state_max;
...
extern char* top_map_listing_dir;
...
extern char* validation_replay_path;
...
extern PlayerInfo* playerReplayWatchers;
...
extern struc_66FE20* stru_66FE20;
...
extern CHAR* bnet_previous_map_dir;
...
extern char* previous_selected_map;
...
extern _DWORD* AiArray;
extern _DWORD* dword_6B5448;
...
extern CycleStruct* cycle_colors;
...
extern int* unknown_palette_trans3;
...
extern activation_delays* stru_6D5E8C;
