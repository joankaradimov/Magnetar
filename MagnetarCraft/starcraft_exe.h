...
extern void *(__stdcall*SMemAlloc)(int amount, const char *logfilename, int logline, int defaultValue);
extern BOOL (__stdcall*SMemFree)(void *location, const char *logfilename, int logline, char defaultValue);
extern BOOL (__stdcall*SRegLoadValue)(const char *keyname, const char *valuename, BYTE flags, int *value);
