...
extern size_t(*SStrVPrintf)(char *dest, size_t size_, const char *format, ...);
...
extern int (__stdcall*SStrCmpI)(const char *string1, const char *string2, size_t size_);
...
extern BOOL (__stdcall*SRegLoadString)(char *keyname, char *valuename, BYTE flags, char *buffer, size_t buffersize_);
...
extern int (__stdcall*SStrCmp)(const char *string1, const char *string2, size_t size_);
extern BOOL (__stdcall*SNetGetProviderCaps)(char *caps);
extern BOOL (__stdcall*SBltROP3)(int maxiterations, int lpSurface, int width, int height, int width2, int pitch, int a7, DWORD rop);
...
extern BOOL (__stdcall*SBmpLoadImage)(const char *fileName, int size_, void *buffer, int buffersize_, int width, int height, int depth);
...
extern void (__stdcall*SMemCopy)(void *dest, const void *source, size_t size_);
...
extern BOOL (__stdcall*SNetGetPlayerName)(int playerid, char *buffer, size_t buffersize_);
extern BOOL (__stdcall*SNetSetGameMode)(DWORD modeFlags, char a2);
extern BOOL (__stdcall*SNetLeaveGame)(int type);
extern BOOL (__stdcall*SNetReportGameResult)(unsigned int a1, int size_, int a3, int a4, int a5);
...
extern BOOL (__stdcall*SBmpDecodeImage)(int type, signed int *srcbuffer, unsigned int a3, int a4, void *dstbuffer, int size_, int a7, int a8, int a9);
...
extern BOOL (__stdcall*SNetReceiveTurns)(int a1, int arraysize_, char **arraydata, unsigned int *arraydatabytes, DWORD *arrayplayerstatus);
...
extern BOOL (__stdcall*SRegLoadData)(char *keyname, char *valuename, BYTE flags, LPBYTE lpData, int size_, LPDWORD lpcbData);
extern BOOL (__stdcall*SRegSaveData)(char *keyname, char *valuename, int size_, BYTE *lpData, DWORD cbData);
...
extern int (__stdcall*SMemCmp)(void *location1, void *location2, size_t size_);
extern int (__stdcall*SBigFromBinary)(void *buffer, const void *str, size_t size_);
extern int (__stdcall*SBigNew)(void **buffer);
extern BOOL (__stdcall*SRegDeleteValue)(char *keyname, char *valuename, BYTE flags);
extern BOOL (__stdcall*SFileLoadFile)(char *filename, void *buffer, int buffersize_, int a4, int a5);
