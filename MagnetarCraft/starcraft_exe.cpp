...
DECL_FUNC(int (__stdcall*imageRenderFxn0_0)(int, tagRECT *, int), imageRenderFxn0_0, 0x40abbe);
...
DECL_FUNC(void *(__stdcall*SMemAlloc)(int amount, const char *logfilename, int logline, int defaultValue), SMemAlloc, 0x41006a);
DECL_FUNC(BOOL (__stdcall*SMemFree)(void *location, const char *logfilename, int logline, char defaultValue), SMemFree, 0x410070);
DECL_FUNC(BOOL (__stdcall*SRegLoadValue)(const char *keyname, const char *valuename, BYTE flags, int *value), SRegLoadValue, 0x410076);
DECL_FUNC(int (__stdcall*SStrNCat)(char *base, const char *new_, int max_length), SStrNCat, 0x41007c);
...
BOOL getActiveTileFlag(__int16 x, __int16 y, int a3, int a4) {
...
DECL_FUNC(int (__fastcall*gndSightCB_Inside)(int, int, SightStruct *, MegatileFlags *, unsigned int, unsigned int), gndSightCB_Inside, 0x480200);
DECL_FUNC(int (__stdcall*airSightCB_Edge)(int, int, int, int), airSightCB_Edge, 0x4802a0);
DECL_FUNC(int (__fastcall*airSightCB_Inside)(int, int, SightStruct *, MegatileFlags *, unsigned int, unsigned int), airSightCB_Inside, 0x480310);
...
int revealSightAtLocation(int sight_range, unsigned int vision_mask, signed int x, signed int y, int a5) {
...
struct_3(&stru_5193A8)[228] = * ((decltype(&stru_5193A8)) 0x5193a8);
...
int(&dword_5240BC)[] = * ((decltype(&dword_5240BC)) 0x5240bc);
...
char(&byte_640898)[] = * ((decltype(&byte_640898)) 0x640898);
char(&byte_6408F8)[] = * ((decltype(&byte_6408F8)) 0x6408f8);
...
int(&dword_658B10)[] = * ((decltype(&dword_658B10)) 0x658b10);
...
char(&byte_66FBE4)[] = * ((decltype(&byte_66FBE4)) 0x66fbe4);
