...
extern void (__fastcall*BlitTerrainCacheToGameBitmap)(int this_, int edx0, int a2, int a3);
...
extern int (__stdcall*sub_42A5C0)(int *a1, Position *a2, signed __int16 *a3);
...
unsigned int AI_Build(unsigned int result, char a2, unsigned int unit_type, int a4, char a5);
...
signed int prepContourInfoForSaving(BYTE *a1);
...
extern void(*sub_46F5B0)(int x, int y, CUnit *unit, signed int a4);
...
BOOL j_canUnitTypeFitAt(signed int x, UnitType unit_type, __int16 y);
...
extern void (__stdcall*BWFXN_KillUnitTarget)(CUnit *a1);
...
extern void (__thiscall*BWFXN_PlayIscript)(CImage *image, IScriptProgram *program_state, int noop, _DWORD *distance_moved);
...
signed int isBadName(int a1, const char *name, size_t name_length);
...
extern ButtonOrder(&larva_buttons)[9];
...
extern ButtonOrder(&hydralisk_buttons)[8];
extern ButtonOrder(&mutalisk_buttons)[7];
...
extern int(&dword_685188)[228][12];
extern int(&dword_687C48)[228][12];
extern int(&dword_68A708)[12];
