...
extern unsigned int (__fastcall*GetApproxDistance)(int x, int a2, int y, int a4);
...
extern void (__fastcall*BTNSACT_Move)(int, bool);
...
extern int (__stdcall*addItemProc)(MapDirEntry *, char *, MapDirEntryFlags);
...
extern int (__stdcall*sub_44A560)(MapDirEntry *, char *, MapDirEntryFlags);
...
extern void(*orders_DefensiveMatrix)(CUnit *a1);
...
extern int (__thiscall*RECV_StartGame)(int ecx0, int a1);
...
extern int (__stdcall*AddMapToList_CB)(MapDirEntry *, char *, MapDirEntryFlags);
...
extern int(*loadMenu_gluExpCmpgn)();
...
extern const char *(__fastcall*getRaceName)(__int16 race_key);
...
extern void(*orders_PlaceAddon)(CUnit *a1);
...
extern ButtonOrder(&stru_516630)[10];
extern ButtonOrder(&stru_5166F8)[9];
