...
extern ImageFlags (__thiscall*showImage)(CImage *this_);
...
extern _DWORD (__stdcall*getUnitDistanceToHalt)(_DWORD a1);
...
extern char (__fastcall*sub_40AD04)(int a1, int a2, int a3, int a4, int a5);
...
extern void (__fastcall*scSpecialChars)(int a1, int a2);
...
extern int (__thiscall*sub_417270)(_DWORD a1);
...
unsigned dlgMouseOverGenericLabel(dialog *a1);
...
extern int (__thiscall*sub_418440)(_DWORD a1);
...
extern signed (*realizePalette)();
extern int (__stdcall*sub_41D780)(__int16 a3, __int16 a4);
extern u8 * (__fastcall*drawVertLine)(int a1, unsigned __int16 a2, __int16 a3, unsigned __int16 a4);
...
extern int (__thiscall*___vsnprintf)(char * a1);
...
int __snprintf(char *buff, size_t size__, const char *format, ...);
...
extern void (*CMDACT_CancelNuke)();
extern void (*CMDACT_MergeDarkArchon)();
extern void (*CMDACT_MergeArchon)();
...
extern void (*CMDACT_CancelAddon)();
extern void (*CMDACT_CancelUpgrade)();
extern void (__fastcall*CMDACT_Upgrade)(int action_variable, bool is_shift_used);
extern void (*CMDACT_CancelResearch)();
...
extern void (*CMDACT_TrainFighter)();
extern void (*CMDACT_ReaverStop)();
extern void (*CMDACT_CarrierStop)();
extern void (__fastcall*CMDACT_Stop)(int action_variable, bool is_shift_used);
extern void (*CMDACT_CancelUnitMorph)();
extern void (*CMDACT_CancelConstruction)();
...
extern void (__thiscall*BTNSACT_Heal)(StatusFlags this_);
extern void (__thiscall*BTNSACT_UseNuke)(StatusFlags this_);
extern void (__thiscall*BTNSACT_RechargeShields)(StatusFlags this_);
extern void (__fastcall*CMDACT_UnloadAll)(int action_variable, bool is_shift_used);
extern void (*BTNSACT_LoadUnit)();
extern void (__thiscall*BTNSACT_Harvest)(StatusFlags this_);
extern void (__thiscall*BTNSACT_Repair)(StatusFlags this_);
extern char (__fastcall*BTNSACT_BuildingLand)(UnitType a1);
extern char (__fastcall*BTNSACT_PlaceNydusExit)(UnitType a1);
extern void (__fastcall*BTNSACT_ZergBuild)(UnitType a1);
extern void (__fastcall*BTNSACT_PlaceAddon)(int a1);
extern void (__fastcall*BTNSACT_BuildProtoss)(UnitType a1);
extern char (*BTNSACT_PlaceCOP)();
extern void (__fastcall*BTNSACT_BuildTerran)(int a1);
extern void (__fastcall*BTNSACT_UseTech)(unsigned __int16 a1);
extern void (__fastcall*BTNSACT_Patrol)(int a1, bool a2);
extern void (__thiscall*BTNSACT_ReaverAttack)(StatusFlags this_);
extern void (__thiscall*BTNSACT_CarrierAttack)(StatusFlags this_);
extern void (__thiscall*BTNSACT_CarrierMove)(StatusFlags this_);
extern void (__thiscall*BTNSACT_TowerAttack)(StatusFlags this_);
extern void (__thiscall*BTNSACT_AttackUnit)(StatusFlags this_);
extern void (__fastcall*BTNSACT_AttackMove)(int a1, bool a2);
extern void (__fastcall*BTNSACT_Move)(int a1, bool a2);
extern void (__thiscall*BTNSACT_RallyPoint)(StatusFlags this_);
...
extern int (__stdcall*BTNSCOND_CanRechargeShields)(int a1);
...
extern signed (__stdcall*BTNSCOND_HasInterceptors)(int a1);
...
extern void (*BTNSACT_TargetOrderCancel)();
extern void (*BTNSACT_CancelPlacement)();
...
struct Path * reAssignPath(CUnit * a1);
...
extern int (__thiscall*filterUnitStrength)(_DWORD a1);
...
extern void (*calculateUnitStrengths)();
Position sub_4314F0(CUnit * a1, int a2);
int sub_431550(int a1, CUnit *a2);
extern int (__fastcall*BeefUnitStrength_AirOrGround)(_DWORD a1, _DWORD a2);
...
extern int (__fastcall*isUnknownSpellcaster)(_DWORD a1, _DWORD a2);
...
extern int (__fastcall*sub_439050)(_DWORD a1, _DWORD a2);
...
extern BOOL (__fastcall*powerupCanBePickedUpProc)(CUnit * a1, CUnit * a2);
...
extern BOOL (*BNProfileImageCreate)();
...
extern _DWORD (__stdcall*sub_44D0C0)(_DWORD a1);
char ** sub_44D100(_DWORD * a1);
extern char * (*sub_44D120)();
extern char (__fastcall*sub_44D140)(const char * a1, LPARAM a2, HWND hDlg);
extern int (__stdcall*SaveProfileChanges)(HWND hDlg);
BOOL sub_44D450(HWND a1);
extern int (__fastcall*sub_44D540)(char * a1, int a2, int a3);
...
extern int (__stdcall*BattleDrawProfileInfo)(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10, int a11);
...
BOOL sub_44FA60(int a1, int a2, char a3);
...
signed j_JoinNetworkGame(GameData *a3);
...
extern void * (*sub_453150)();
extern void * (*sub_453170)();
...
int sub_453BA0(const void *a1, size_t a2, const void *a3, size_t size__);
...
extern void (__fastcall*BTNSACT_ChangeButtons)(__int16 a1);
...
extern int (__stdcall*dataXFer_0x03)(int a1);
...
extern s32 (__fastcall*Score)(int a1, __int16 a2, struct_a3 * a3);
extern int (__fastcall*Opponents)(int ecx0, int a2, struct_a3 * a3);
extern s32 (__fastcall*Deaths)(int a1, unsigned __int16 a2, struct_a3 * a3);
extern s32 (__fastcall*Kill)(int a1, unsigned __int16 a2, struct_a3 * a3);
extern int (__fastcall*Accumulate)(int a1, __int16 a2, struct_a3 * a3);
extern int (__fastcall*Command)(int a1, unsigned __int16 edx0, struct_a3 * a3);
...
extern dialog * (__fastcall*sub_460A90)(dialog * a1);
...
extern signed (__fastcall*savegameBIN)(__int16 a1);
...
extern int (__fastcall*savegameBIN_DLG_Interact)(dialog * a1, dlgEvent * a2);
...
extern int (__fastcall*getHangerTrainCount)(_DWORD a1, _DWORD a2);
...
extern int (__thiscall*sub_468EF0)(_DWORD a1);
...
extern int (__fastcall*assignUnitSorting_Y)(_DWORD a1, _DWORD a2);
extern int (__fastcall*assignUnitSorting_X)(_DWORD a1, _DWORD a2);
...
struct ActiveTile * sub_469F40(CUnit * a1);
...
extern TriggerListEntry * (__stdcall*sub_46CBC0)(dialog * a1);
extern void (*updateMissionObjectives)();
void BRF_displayText(char *text, unsigned int a2);
extern void (__fastcall*ShowPortrait)(int a1, int a2, unsigned __int16 a3);
...
void LOBSEND_BootPlayer(char a1, int a2, int a3);
...
extern int (__thiscall*UnitIsResourceContainer)(CUnit *this_);
...
extern signed (__stdcall*canBuildOnTileLocation)(CUnit * a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9);
...
extern signed (__thiscall*AI_UnitCanAttack)(CUnit *this_);
...
extern int (__fastcall*unitOrderMoveToTargetUnitResetOrderState)(_DWORD a1, _DWORD a2);
...
extern unsigned (__fastcall*imageRenderFxn11_0)(int a1, int a2, int a3, int a4, CUnit * a5);
...
signed sub_47DE40(int a1, int a2, int eax0, UnitType a3);
...
extern _DWORD (__stdcall*sub_47EA60)(_DWORD a1, _DWORD a2);
int GetScrollSpeed(int *a1);
extern char (*CenterCursorGameScreen)();
void assignCenterViewProc(int a1, int a2, unsigned (*a3)(void));
...
extern unsigned (__fastcall*sub_480B30)(int a1, int a2);
...
extern int (__stdcall*BitContextHelpSurface)(Bitmap * a1);
extern int (__fastcall*sub_481260)(int a1, __int16 a2, Bitmap * a3, __int16 a4);
...
dlgEvent * createUpdateSpdOptionsScrollers(dialog * a1);
...
extern void (__thiscall*input_MiddleBtnScreenMove_MouseMove)(dlgEvent * a1);
...
extern int (__stdcall*sub_485CE0)(char a1);
...
int sub_487350(int result, struct _UNKNOWN * a2, int a3);
unsigned sub_4873E0(int a1, struct _UNKNOWN * a2, unsigned int a3);
int * initializeThingyArray(unsigned __int16 count, CThingy **a2, CThingy **a3, CThingy *a4, int (__thiscall *a5)(void *));
extern unsigned (*packThingyData)();
...
extern BOOL (__fastcall*sub_487A90)(CUnit * a1, __int16 a2);
...
extern unsigned (*defCenterViewProc)();
...
signed InitPlacementBoxPos_maybe(int a2);
...
extern void (__fastcall*sub_494F60)(CFlingy * a1, int a2);
...
extern void (__stdcall*selectUnitGroup)(unsigned __int8 a1);
...
extern char (__stdcall*sub_4970F0)(__int16 * a1);
extern void (__cdecl*createUnitBuildingSpriteValidityArray)();
extern unsigned (*initializeSpriteArray)();
...
extern int * (__thiscall*sub_497D80)(void *this_);
...
extern int (__stdcall*sub_49B320)(char a1);
...
extern char (*BWFXN_UpdateScreenPosition)();
...
extern DWORD (*sub_4A2BD0)();
extern void (*TickCounterInit)();
...
extern void (__stdcall*sub_4A7F50)(HWND hWnd, UINT a2, UINT uIDEvent, DWORD a4);
...
extern int (__thiscall*sub_4AAFF0)(int this_);
...
extern int (__thiscall*sub_4AD400)(_DWORD a1);
...
extern int (__stdcall*callback)(DWORD a1);
...
signed campaignTypeCheatStrings(const char *a2);
__int64 * makeCheatHash(const char *cheat, __int64 * a2);
void cheatActivation(int result, const char *player_name);
signed radioFreeZergCheat(const void *a2, CheatFlags *cheat_flags);
...
extern unsigned (__thiscall*sub_4BA290)(dialog *this_);
...
extern unsigned (__stdcall*DSoundThread)(void *a2);
...
extern signed (*cursorRefresh)();
extern BYTE (*RefreshCursor_0)();
extern DWORD (*sub_4BE100)();
...
extern int (__thiscall*sub_4BF370)(FILE *a3, void *a1, int a2);
...
extern void (__stdcall*sub_4BFC50)(__int16 a1, __int16 a2);
void sub_4BFC80(char a1, int a2, int a3);
extern void (*sub_4BFCB0)();
extern CUnit * (*CMDRECV_CancelNuke)();
extern void (*sub_4BFD30)();
extern void (*sub_4BFD50)();
extern void (*sub_4BFD70)();
extern void (*sub_4BFD90)();
...
extern void (*sub_4BFFA0)();
extern void (*CMDRECV_CancelUpgrade)();
extern void (*sub_4C0030)();
void sub_4C0050(char a1);
extern void (*CMDRECV_CancelResearch)();
extern void (*sub_4C00C0)();
...
extern void (*sub_4C0200)();
extern void (*sub_4C0220)();
void sub_4C0240(char a1);
void sub_4C0260(char a1);
extern void (*sub_4C0280)();
extern void (*sub_4C02A0)();
extern void (*sub_4C02C0)();
...
extern void (__fastcall*CMDACT_ResumeGame)(int a1);
extern void (__fastcall*CMDACT_PauseGame)(int a1);
...
extern void (__fastcall*sub_4C0560)(char a1, __int16 a2, int a3);
void sub_4C0590(int a1, char a2, _BYTE * a3);
extern void (*sub_4C05A0)();
...
extern char (*CMDRECV_MergeDarkArchon)();
...
signed updateBuildingLandUnitSelection(CUnit *a2);
...
extern int (__thiscall*sub_4C4870)(void *this_);
...
extern void (__thiscall*CMDACT_RestartGame)(dialog * a1);
...
extern void (__fastcall*saveGameCBProc)(dialog * a1, __int16 a2);
...
extern int (__stdcall*mapAuthCallback)(char *szFileName, void * a2, HANDLE * a3);
...
extern GameActionDataBlock * (*sub_4CDFC0)();
extern GameActionDataBlock * (*sub_4CDFD0)();
...
extern int (*sub_4CE470)();
extern const char * (*sub_4CE4A0)();
signed GetMapSaveDirectory(char *a1, unsigned int esi0, const char *a2);
signed getSaveDirectory(char *a1, unsigned int esi0, char *a2, int a4);
...
extern int (__thiscall*getUpgradesLevel)(_DWORD a1);
...
extern int (__fastcall*enumSaveLoadFiles)(char * a1, const char *edx0, int (__fastcall * a3)(char *, struct _WIN32_FIND_DATAA *, int, int) , int a4, int a5, int a6, int a7);
extern _DWORD (__stdcall*createSaveLoadList)(_DWORD a1, _DWORD a2);
extern signed (*sub_4CF5F0)();
...
extern void (*UpdateDlgMousePosition)();
...
signed JoinNetworkGame(GameData *a3);
...
extern char (__fastcall*imageRenderFxn6_1)(int a1, int a2, int a3, tagRECT * a4, int a5);
extern char (__fastcall*imageRenderFxn6_0)(int a1, int a2, int a3, tagRECT *a4, int a5);
extern char (__fastcall*imageRenderFxn5_1)(int a1, int a2, int a3, tagRECT * a4, int a5);
...
extern void (__fastcall*imageRenderFxn12_1)(int a1, int a2, grpFrame * a3, rect * a4, int a5);
...
extern void (*BeginCredits)();
extern void (*BeginEpilog)();
...
extern unsigned (*resetLastInputFrameCounts)();
...
extern int (__thiscall*sub_4DB180)(void *this_);
extern int (__thiscall*sub_4DB1C0)(void *this_);
...
extern BYTE (*setSinglePlayerValue)();
...
extern void (*loadTFontPcx)();
extern void (*loadtEffectPcx)();
...
signed trimTrailingSpaces(const char *a2);
...
extern void (*CMDACT_SetReplaySpeed)();
...
extern void (__fastcall*PlayVideoFrame)(dialog * a1, __int16 a2);
...
extern _DWORD (__stdcall*upgradeAllUpgradesFromUnit)(_DWORD a1, _DWORD a2);
extern _DWORD (__stdcall*researchAllTechsFromUnit)(_DWORD a1, _DWORD a2);
...
extern BOOL (__fastcall*larvaCounterProc)(CUnit * a1, CUnit * a2);
...
extern int (__fastcall*mapDataTransfer)(_DWORD a1, _DWORD a2);
...
extern int (__stdcall*sub_4EDEF0)(int a1);
