...
extern int (__fastcall*sub_4323C0)(UnitType unit_type, char a3);
...
extern signed int (__stdcall*AI_PlanDoMergeMorph)(int a1, CUnit *unit, int a3);
...
extern int (__stdcall*populateAttackRegions)(int, int x, int y, int, int);
...
extern int (__stdcall*getClosestBaseFromStartLocation)(int, int y);
...
extern int (__stdcall*parseLocalSBigBuffer)(int a2, void *, int, void *str, size_t size_, void *, size_t);
...
extern signed int (__thiscall*OrderAcquire_genericReturnToIdleProc)(CUnit *unit, int a2, CUnit **a3, int a4);
...
extern int (__thiscall*orderNewUnitToFollowRallyDirective)(CUnit *unit);
...
extern signed int (__stdcall*SortAllUnits)(CUnit **a1, CUnit **a2, CUnit *a3);
...
extern void (__fastcall*input_dragSelect_MouseBtnUp)(dlgEvent *);
extern void (__fastcall*input_Game_LeftMouseClick)(dlgEvent *);
...
extern void (__thiscall*RECV_StartGame)(int ecx0, int a1);
...
extern void *(__thiscall*sub_47D170)(void *this_, _DWORD a2);
...
extern void (__fastcall*input_targetOrder_RightMouseClick)(dlgEvent *);
extern void (__fastcall*input_placeBuilding_RightMouseClick)(dlgEvent *);
...
extern int (__stdcall*getClosestEnemyUnitToRegionPlayer)(int, int x, int y);
...
extern int (__fastcall*sub_4BB260)(LPVOID *data, DWORD *senderplayerid);
...
extern void (__fastcall*input_targetOrder_LeftMouseClick)(dlgEvent *);
...
extern void (__fastcall*BWFXN_QuitReplay_maybe)(dialog *dlg);
