...
extern int (__stdcall*sub_4F16C0)(int, signed __int16 *a3, int);
...
extern __int16& active_timers_count_maybe;
extern swishTimer(&active_timers_maybe)[1];
