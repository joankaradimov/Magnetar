...
extern int (__thiscall*CMDACT_LoadGame)(char *source);
...
extern signed int (__stdcall*UMScoutPath)(CUnit *unit);
...
extern void (__stdcall*TimerFunc)(HWND a2, UINT a3, UINT a4, DWORD a5);
...
extern CImage *(__thiscall*iscriptCloaking)(CImage *this_);
...
extern void (__fastcall*sub_4D6F00)(int a1, CSprite *a2, unsigned int a3, unsigned int a4);
