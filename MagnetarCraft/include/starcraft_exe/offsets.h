...
extern char (__fastcall*rle_draw_effect)(int a1, int a2, int a3, tagRECT *a4, int a5);
...
extern char (__fastcall*rle_draw_cloak)(int a1, int a2, int a3, tagRECT *a4, int a5);
...
extern void (__fastcall*rle_draw_texture_hflip)(int a1, int a2, grpFrame *a3, rect *a4, int a5);
