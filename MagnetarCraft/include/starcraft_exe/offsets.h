...
extern char (__fastcall*imageRenderFxn3_0)(int a1, int a2, int a3, tagRECT *a4, int a5);
extern char (__fastcall*imageRenderFxn8_0)(int a1, int a2, int a3, tagRECT *a4, int a5);
extern char (__fastcall*imageRenderFxn17_0_cntd)(int a1, int a2, grpFrame *a3, RECT *a4, int a5);
extern char (__fastcall*imageRenderFxn9_0)(int a1, int a2, int a3, tagRECT *a4, int a5);
extern char (__fastcall*imageRenderFxn10_0)(int a1, int a2, grpFrame *a3, RECT *a4, int a5);
extern char (__fastcall*imageRenderFxn5_2__1_common)(int a1, int a2, int a3, tagRECT *a4, int a5);
extern char (__fastcall*imageRenderFxn3_1)(int a1, int a2, int a3, tagRECT *a4, int a5);
extern char (__fastcall*imageRenderFxn8_1)(int a1, int a2, int a3, tagRECT *a4, int a5);
extern char (__fastcall*imageRenderFxn9_1)(int a1, int a2, int a3, tagRECT *a4, int a5);
extern char (__fastcall*imageRenderFxn17_1_cntd)(int a1, int a2, grpFrame *a3, RECT *a4, int a5);
extern char (__fastcall*imageRenderFxn0_1)(int a1, int a2, grpFrame *a3, RECT *a4, int a5);
extern char (__fastcall*imageRenderFxn10_1)(int a1, int a2, grpFrame *a3, RECT *a4, int a5);
...
extern int (__stdcall*sub_41D780)(__int16 a1, __int16 a2);
...
extern int (*setGroundBuildingPathing)(void);
...
extern int (*setArchonWarpPathing)(void);
...
extern void (__thiscall*RECV_StartGame)(int ecx0, int a2);
...
extern int (*unit_isRefineryUnit)(void);
...
extern int (*resetAllUnitAttackNotifyTimersInRange)(void);
...
extern int (*CancelAddon_Direct)(void);
...
extern char (__stdcall*sub_4F3CA0)(CUnit *a1, CUnit *a2);
