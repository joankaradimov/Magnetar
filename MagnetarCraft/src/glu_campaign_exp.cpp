...
std::vector<Campaign> exp_campaigns = {
	{
		"xprotoss",
		1,
		true,
		RaceId::RACE_Protoss,
		{
			...
			cinematic(0x56, ExpandedMapData::EMD_xterran01, C_FURY_OF_THE_XEL_NAGA, SVID_AUTOCUTSCENE | StormVideoFlags::SVID_FLAG_UNK, 0),
		},
	...
	},
	{
		...
		RaceId::RACE_Terran,
		{
			...
			cinematic(0x57, ExpandedMapData::EMD_xzerg01, C_UED_VICTORY_REPORT, SVID_AUTOCUTSCENE | StormVideoFlags::SVID_FLAG_UNK, 0),
		},
		MenuPosition::GLUE_EX_CAMPAIGN,
	},
	{
		...
		RaceId::RACE_Zerg,
		{
			...
			cinematic(0x55, ExpandedMapData::EMD_Unknown, C_THE_ASCENTION, SVID_AUTOCUTSCENE | StormVideoFlags::SVID_FLAG_UNK, 0),
...
{
	active_campaign_set = &exp_campaign_set;
	OpheliaEnabled = 0;
	multiPlayerMode = 0;
	sub_4B5050();
