...
char(&aDlgsTile_grp)[14] = * ((decltype(&aDlgsTile_grp)) 0x5029f4);
...
int(&dword_59A0D4)[] = * ((decltype(&dword_59A0D4)) 0x59a0d4);
...
__int16& dword_6CEF40 = * ((decltype(&dword_6CEF40)) 0x6cef40);
...
HINSTANCE& hModule = * ((decltype(&hModule)) 0x6d5de4);
