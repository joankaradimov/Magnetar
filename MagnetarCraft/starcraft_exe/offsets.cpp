...
DECL_FUNC(int (__stdcall*AI_BuildBunker)(int unit_type, char a5), AI_BuildBunker, 0x43ebb0);
...
DECL_FUNC(void (__fastcall*a4)(dialog *dlg, __int16 a2), a4, 0x4c9150);
...
char(&dword_512680)[] = * ((decltype(&dword_512680)) 0x512680);
