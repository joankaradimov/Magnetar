...
signed int Template_Destructor_0(TemplateListEntry *a1, int a2);
...
signed int CC_CanBeInfested(CUnit *unit);
...
extern char (__fastcall*imageRenderFxn0_0)(int a1, int a2, grpFrame *a3, RECT *a4, int a5);
extern int (__stdcall*sub_40AD04)(int, int, int);
extern int (__stdcall*sub_40AE63)(grpFrame *, int, int);
extern char (__fastcall*sub_40AFD5)(int a2, int a1, grpFrame *a4, tagRECT *a5, int a6);
extern char (__fastcall*imageRenderFxn3_0)(int a2, int a1, int a4, tagRECT *a5, int a6);
extern char (__fastcall*imageRenderFxn8_0)(int a2, int a1, int a4, tagRECT *a5, int a6);
extern char (__fastcall*imageRenderFxn17_0_cntd)(int a2, int a1, grpFrame *a4, RECT *a5, int a6);
extern char (__fastcall*imageRenderFxn9_0)(int a2, int a1, int a4, tagRECT *a5, int a6);
extern char (__fastcall*imageRenderFxn10_0)(int a2, int a1, grpFrame *a4, RECT *a5, int a6);
extern char (__fastcall*imageRenderFxn5_2__1_common)(int a2, int a1, int a4, tagRECT *a5, int a6);
extern char (__fastcall*imageRenderFxn3_1)(int a2, int a1, int a4, tagRECT *a5, int a6);
extern char (__fastcall*imageRenderFxn8_1)(int a2, int a1, int a4, tagRECT *a5, int a6);
extern char (__fastcall*imageRenderFxn9_1)(int a2, int a1, int a4, tagRECT *a5, int a6);
extern char (__fastcall*imageRenderFxn17_1_cntd)(int a2, int a1, grpFrame *a4, RECT *a5, int a6);
extern char (__fastcall*imageRenderFxn0_1)(int a2, int a1, grpFrame *a4, RECT *a5, int a6);
extern char (__fastcall*imageRenderFxn10_1)(int a2, int a1, grpFrame *a4, RECT *a5, int a6);
void BlitToBitmap(int result, int a2, void *a3, const void *a4);
extern int(*BWFXN_blitMapTiles)();
extern void (__fastcall*BlitTerrainCacheToGameBitmap)(void *this_, int edx0, int a2, int a3);
...
extern int (__fastcall*sub_413F70)(_DWORD, _DWORD);
...
extern int (__thiscall*sub_4144C0)(int a3);
...
extern void (__fastcall*sub_416600)(dialog *, __int16);
...
extern int (__thiscall*setDialogVisibility)(dialog *a1);
...
extern int (__stdcall*sub_418C00)(dialog *a1);
...
extern int (__thiscall*sub_419170)(dialog *a1);
...
extern void (__thiscall*sub_419470)(void *this_);
...
extern void (__cdecl*InitializeDialogScreenLayer)();
...
extern signed int (__stdcall*CtrlNode_Constructor)(dialog *a1, RECT *a2);
...
extern int (__stdcall*sub_41D780)(__int16 a3, __int16 a4);
...
extern int (__stdcall*BlitBitmap)(Bitmap *a1);
...
extern int (__stdcall*InsertContour)(int, int, int);
...
extern int (__fastcall*CMDACT_UnitMorph)(UnitType unit_type);
extern int (__fastcall*CMDACT_BuildingMorph)(UnitType unit_type);
...
extern int (__fastcall*BTNSACT_PlaceAddon)(UnitType unit_type);
extern void (__fastcall*BTNSACT_BuildProtoss)(UnitType a1);
extern int(*BTNSACT_PlaceCOP)();
extern int (__fastcall*BTNSACT_BuildTerran)(UnitType unit_type);
...
extern int (__stdcall*BTNSCOND_HasCargoTerran)(CUnit *unit);
extern int (__stdcall*BTNSCOND_NoCargoTerran)(CUnit *unit);
...
extern int (__stdcall*BTNSCOND_ZergHasCargo)(CUnit *unit);
extern int (__stdcall*BTNSCOND_ZergNoCargo)(CUnit *unit);
...
extern int (__fastcall*BTNSCOND_CanBuildUnit)(UnitType unit_type, int player_id, CUnit *a2);
...
extern int (__stdcall*BTNSCOND_BattleOrders)(CUnit *unit);
...
extern bool (__fastcall*BTNSCOND_HasTech)(Tech a1, int player_id, CUnit *unit);
...
extern signed int (__thiscall*isContourSpaceAvailable)(SaiContourHub *this_, int x, int y);
...
extern signed int (__stdcall*SAI_ContoursCreate_1)(int a1, int *a2, int *a3);
...
signed int isVisible(__int16 y, __int16 x);
extern int(*sub_42D600)();
extern int (__fastcall*getUnitCollision_CB)(CUnit *, void *);
...
BOOL canUnitTypeFitAt(signed int x, UnitType a2, __int16 y);
...
extern unsigned __int16 (__stdcall*sub_42F650)(CUnit *a1, Position a2, Position a3);
...
extern int (__thiscall*unitGetImaginaryPathDistanceToPosition)(CUnit *a1, int);
...
extern int (__fastcall*sub_4323B0)(__int16 a4);
extern int (__fastcall*sub_4323C0)(__int16 a4, char a3);
extern int (__fastcall*AI_Build)(__int16 a4, char a6, char a5);
...
extern int (__stdcall*WriteAITownData)(FILE *a3);
extern int (__stdcall*isGroundMap)(int);
extern int(*getGuardXY)();
extern int (__stdcall*AI_WaitBuild)(int a2, int);
extern int(*sub_433410)();
extern int (__stdcall*sub_433470)(int a2);
...
extern int (__stdcall*sub_434480)(int playerID, int, int);
...
extern int (__stdcall*AI_GetOldPeons)(int a2, int);
...
extern int (__stdcall*AI_PlanDoMergeMorph)(int player_id, CUnit *, int);
...
extern void (__cdecl*j_freeAICaptains)();
...
extern int (__stdcall*WriteAIPathCaptainData)(FILE *a3);
...
extern int (__stdcall*AI_BuildTurret)(int, char a5);
...
extern int (__stdcall*AI_OrderAllUnitsInLocation)(int, Position a4, int, Order a3);
...
extern int (__stdcall*AIUnloading)(CUnit *a1);
...
extern int (__stdcall*AI_BuildBunker)(int unit_type, char a5);
...
extern int (__stdcall*sub_43F990)(int a2);
...
extern int (__fastcall*compareUnitToUnitTypeProc)(CUnit *, void *);
...
extern int (__thiscall*AI_AssignBestRestorationTarget2)(CUnit *a1);
...
extern int (__thiscall*sub_440F10)(CUnit *a1);
extern int (__thiscall*sub_440F50)(CUnit *a1);
...
extern int (__fastcall*AI_IrradiateRequirementsProc)(CUnit *, CUnit *);
extern int (__fastcall*AI_LockdownRequirementsProc)(CUnit *, CUnit *);
...
extern int (__fastcall*canHitUnit)(CUnit *, CUnit *);
...
extern int (__fastcall*AI_MindControlRequirementsProc)(CUnit *, CUnit *);
extern int (__fastcall*AI_FeedbackRequirementsProc)(CUnit *, CUnit *);
...
extern int (__fastcall*AI_BroodlingRequirementsProc)(CUnit *, CUnit *);
extern int (__fastcall*AI_YamatoRequirementsProc)(CUnit *, CUnit *);
...
extern int (__stdcall*getNextNearestMineralsEx)(int unit_type, __int16 a3);
...
extern int (__stdcall*sub_445B00)(int, int a4, int a5);
...
extern int (__thiscall*AIBuildAtLocation)(signed int a2, Position a3, int a4);
...
extern void (__thiscall*AI_Reserve)(int a1, int a3);
extern int (__stdcall*ReadAIBankerData)(FILE *);
extern int (__stdcall*WriteAIControllerData)(FILE *a3);
extern int (__stdcall*sub_448160)(int);
extern int(*sub_448220)();
extern int (__thiscall*ReadAIScriptControllerData)(FILE *);
extern int (__thiscall*AI_MergeMorphSwitch)(int a2, char a4);
extern int (__fastcall*sub_4485B0)(char a4, int a2, int a5, int);
extern int (__thiscall*sub_448630)(int a2);
...
extern unsigned int (__stdcall*sub_44B240)(int a1, int a2, GotFileValues *a3, int a4);
...
extern int (__thiscall*CreateFontHandle)(int cEscapement);
...
extern void (__fastcall*videoSpeakingPortraitLoop)(dialog *a1, __int16 timer_id);
extern int (__stdcall*sub_44EED0)(int a3);
...
extern void (__fastcall*getPlayerCaps)(dialog *, __int16);
extern void (__fastcall*sub_4500D0)(dialog *, __int16);
...
extern int (__stdcall*CreatePlayerOwnerDropdown)(dialog *a1, char *, int, int, char, int);
...
extern void (__thiscall*refundTech75percent)(unsigned __int8 a1, Tech a3);
...
extern int (__fastcall*statdata_UnitWireframeInteract)(dialog *a1, dlgEvent *a2);
...
extern int (__fastcall*statdata_Unknown)(dialog *a1, dlgEvent *a2);
...
extern int (__fastcall*statdata_buttonInteract)(dialog *a1, dlgEvent *a2);
...
extern void (__cdecl*free_cmdIcons)();
...
extern int (__stdcall*sub_459D90)(_DWORD);
extern int(*sub_459DC0)();
extern int(*sub_459E00)();
extern int (__stdcall*sub_459EF0)(_DWORD);
...
extern int (__stdcall*AI_ExpandAt)(int, int, int a3);
...
extern int (__stdcall*sub_45CD50)(int a1, int a2, int, int, int);
...
extern int (__thiscall*sub_45EF50)(dialog *a2);
...
extern int (__fastcall*Score)(_DWORD, _DWORD, struct_a3 *);
extern int (__fastcall*Opponents)(_DWORD, _DWORD, struct_a3 *);
extern int (__fastcall*Deaths)(_DWORD, _DWORD, struct_a3 *);
extern int (__fastcall*Kill)(_DWORD, _DWORD, struct_a3 *);
extern int (__fastcall*Accumulate)(_DWORD, _DWORD, struct_a3 *);
extern int (__fastcall*Command)(_DWORD, _DWORD, struct_a3 *);
...
extern int(*open_lose_mission_dialog)();
...
extern int (__thiscall*verifyResources)(int playerId, int);
extern int (__thiscall*orderNewUnitToFollowRallyDirective)(CUnit *a1);
...
extern int (__stdcall*UMScoutPath)(CUnit *a1);
...
extern int (__fastcall*sub_46C6E0)(dialog *this_, int x, int y, rect *a3);
extern void (__fastcall*waitLoop)(dialog *, __int16);
...
extern void (__fastcall*BRF_RectLoop1)(dialog *, __int16);
extern void (__fastcall*textScrollLoop)(dialog *, __int16);
...
extern int (__thiscall*sub_46F380)(int a2);
extern int (__stdcall*FindUnitAtPoint)(int a2, int a1);
...
extern int (__stdcall*RECV_ForceChangeUMS)(int a2, int);
...
BOOL j_canUnitTypeFitAt(signed int x, UnitType a2, __int16 y);
...
extern int (__stdcall*sub_4762C0)(CUnit *unit, int a2, int a3);
extern int (__thiscall*isTargetWithinMinMovementRange)(unsigned int min_range);
...
signed int IsReadyToAttack(CUnit *a1, WeaponType weapon_type);
...
extern void (__stdcall*loadImagesData)(LO_Overlays *a1, int *a2, unsigned __int16 *images_tbl, int a4, LPOVERLAPPED a5, _DWORD *a6);
...
extern int (__stdcall*sub_47D860)(int a4, int a5, CUnit *);
...
extern void (__stdcall*sub_47E2D0)(int x, int y, int a3, TileID a4, RECT *a1);
...
extern int (__stdcall*sub_481260)(Bitmap *a2, __int16);
...
extern void (__fastcall*nullsub_3)(dlgEvent *);
extern int(*saveScreenLocation)();
extern void (__fastcall*input_Game_LeftMouseBtnDwn)(dlgEvent *);
extern void (__thiscall*_input_Game_Idle)(dlgEvent *this_);
extern void (__fastcall*input_Game_MiddleMouseBtnUp)(dlgEvent *);
extern void(*resetGameInputProcs)(CursorType a1);
extern void (__thiscall*input_MiddleBtnScreenMove_MouseMove)(dlgEvent *);
extern int(*recallScreenLocation)();
extern void (__fastcall*input_Game_MiddleMouseBtnDwn)(dlgEvent *);
...
extern void (__fastcall*input_Game_RightMouseBtnDwn)(dlgEvent *);
extern void (__fastcall*input_Game_UserKeyPress)(dlgEvent *);
extern void (__fastcall*CMDACT_Hotkey)(dlgEvent *);
...
extern int (__thiscall*isValid)(void *);
extern int (__thiscall*isNull)(void *);
...
extern int (__stdcall*placebuildingUpdateProc)(Bitmap *a2, int);
...
extern int (__thiscall*CMDRECV_PlaceBuildingAllowed)(CUnit *a1);
...
extern int (__stdcall*cmdRECV_PlaceBuildingAddon)(int a3, Order, int a5);
...
extern int (__fastcall*resetUnitAttackNotifyTimer)(CUnit *, CUnit *);
...
extern int (__fastcall*msgfltr_SendToText)(dialog *a1, struct dlgEvent *evt);
...
extern int (__fastcall*orderAllMoveToRechargeShieldsProc)(CUnit *, CUnit *);
...
int sub_494BD0(char direction, char a2);
...
extern int (__fastcall*AppearOnTarget)(signed __int16 a3, __int16 a2);
...
extern __int16 (__stdcall*GetFormationMovementTarget)(CUnit *unit, int a2);
...
extern int (__stdcall*PrepareFormationMovement)(int);
...
extern int (__stdcall*sub_49B320)(unsigned int result);
...
extern int (__stdcall*sub_49E8A0)(CUnit *a2);
...
signed int InitializeUnitBase(UnitType a1, CUnit *a2, int a3, __int16 a4, int a5);
...
extern int (__stdcall*AI_CreateUnit)(int a0, int a4);
...
extern int (__fastcall*RemoveAIControl)(CUnit *a2, int);
...
extern void (__fastcall*updateMinimapPositioninfoProc)(dialog *, __int16);
...
extern void (__fastcall*updateMinimapSurfaceInfoProc)(dialog *, __int16);
extern void (__fastcall*updateMinimapSurfaceInfo2Proc)(dialog *, __int16);
extern void (__fastcall*playerInfoSomethingTvBProc)(dialog *, __int16);
...
extern int (__stdcall*MinimapGameRightclickEventMoveto)(dialog *a2);
...
signed int sub_4AADF0(GotFileValues *got_template_values, char *template_label, char a3, TemplateConstructor template_constructor, char *template_name, struct_a4 *a6);
...
extern int (__stdcall*sub_4AB310)(char a3, int);
...
extern unsigned __int8 (__thiscall*sub_4AD3E0)(dialog *this_);
...
extern int (__stdcall*HideShowDlgCallback)(int, dialog *a1, int);
...
extern int (__stdcall*sub_4ADEA0)(char *a1, int, int, int);
extern int (__stdcall*AddMapToList_CB)(int, char *a1, int);
...
extern int(*gluCustmSinglePlayerInit)();
...
extern bool (__fastcall*gluModemStatus_Main)(dialog *dlg, dlgEvent *evt);
...
extern signed int (__stdcall*sub_4B2810)(dialog *a1);
...
extern void (__fastcall*DLG_GlueScoreFillEnd)(dialog *, __int16);
...
extern int (__thiscall*load_gluPOKSplitBINDLG)(char *a1);
...
extern int (__stdcall*GameNode_Destructor_0)(_DWORD, _DWORD);
extern int (__stdcall*updateDLGSpeedSetting)(dialog *a1);
...
extern int (__fastcall*sub_4BB170)(int a4, char *a3, int a2, int a5);
...
extern void (__fastcall*DrawGameProc)(int a1, int a2, Bitmap *, bounds *);
extern void (__cdecl*InitializeGameLayer)();
extern int(*initMapData)();
extern int(*sub_4BDB00)();
extern int (__thiscall*sub_4BDB30)(PALETTEENTRY *this_, PALETTEENTRY a2);
...
extern void (__fastcall*cursorUpdateProc)(int, int, Bitmap *, bounds *);
...
extern int (__thiscall*sub_4BF370)(FILE *a3, void *a1, int);
...
extern int (__stdcall*sub_4C4A80)(int player, int);
extern int(*userHasMap)();
extern int (__stdcall*playerLeaveGame)(int a4, int, int);
...
extern int (__fastcall*giveUnitsProc)(_DWORD, _DWORD);
...
extern void (__fastcall*BWFXN_QuitReplay_maybe)(dialog *this_);
...
extern void (__fastcall*BWFXN_QuitMission)(dialog *this_);
...
extern void (__fastcall*saveGameCBProc)(dialog *, __int16);
...
extern bool (__stdcall*ChkLoader_MRGN_1_00)(SectionData *, int, MapChunks *);
...
extern int (__stdcall*sub_4D2BF0)(char *a1, int, LPOVERLAPPED a3, char *logfilename, int logline);
...
extern int (__thiscall*sub_4D2E60)(char *filename);
...
extern void (__cdecl*j_InitializeInputProcs)();
...
extern int(*GameUpgrade)(_DWORD *a3);
...
extern void (__fastcall*endVideoProc)(dlgEvent *);
...
extern void (__fastcall*TitleLoopTimer)(dialog *, __int16);
...
extern char (__fastcall*imageRenderFxn16_1)(int a1, int a2, grpFrame *a3, RECT *a4, int a5);
extern char (__fastcall*imageRenderFxn16_0)(int a1, int a2, grpFrame *a3, RECT *a4, int a5);
extern __int16 (__fastcall*imageRenderFxn15_0)(__int16 a1, unsigned __int16 a2, grpFrame *a3, RECT *a4, int a5);
extern char (__fastcall*imageRenderFxn13_0)(int a1, int a2, grpFrame *a3, RECT *a4, unsigned __int8 a5);
char imageRenderFxn12_Main(rect *a1, int a2, int a3);
extern char (__fastcall*imageRenderFxn17_1)(int a1, int a2, grpFrame *a3, int a4, unsigned __int8 a5);
extern char (__fastcall*imageRenderFxn17_0)(int a1, int a2, grpFrame *a3, RECT *a4, unsigned __int8 a5);
extern int (__stdcall*imageRenderFxn6_1)(int a4, tagRECT *a5, int);
extern char (__fastcall*imageRenderFxn6_0)(int a1, int a2, int a3, tagRECT *a4, int a5);
extern int (__fastcall*imageRenderFxn5_1)(int a2, int a1, int a4, tagRECT *a5, int a6);
extern char (__fastcall*imageRenderFxn5_0)(int a1, int a2, int a3, tagRECT *a4, int a5);
extern char (__fastcall*imageRenderFxn2_1)(int a1, int a2, int a3, tagRECT *a4, int a5);
extern char (__fastcall*imageRenderFxn2_0)(int a1, int a2, grpFrame *a3, tagRECT *a4, int a5);
...
extern __int64 (__thiscall*updateImagePositionOffset)(CImage *this_);
...
extern char (__fastcall*imageRenderFxn12_0)(int a1, int a2, int a3, rect *a4, int a5);
extern void (__thiscall*iscriptDecloaking)(CImage *this_);
extern int (__thiscall*iscriptCloaking)(CImage *result);
...
extern int (__fastcall*imageRenderFxn14_1)(int a1, int a2, grpFrame *a3, RECT *a4, char a5);
extern int (__fastcall*imageRenderFxn14_0)(int a1, int a2, grpFrame *a3, RECT *a4, char a5);
...
extern int(*writeImages)(FILE *a2);
...
extern CImage *(__stdcall*ISCRIPT_CreateImage)(CImage *a1, int a2, char a3, int arg_C, ImageOrder image_order);
...
extern void (__thiscall*BWFXN_PlayIscript)(CImage *image, IScriptProgram *program_state, int noop, int *distance_moved);
...
extern int (__fastcall*sub_4DB260)(char *filename, int defaultValue, int *bytes_read, int, int);
...
unsigned int RandomizeShort(int a1);
...
extern void (__fastcall*DLGSwishOutProc)(dialog *, __int16);
extern void (__fastcall*sub_4DCEA0)(dialog *, __int16);
...
extern void (__fastcall*DLG_SwishInLock)(dialog *, __int16);
...
extern void (__fastcall*DLGSwishInProc)(dialog *, __int16);
...
extern void (__fastcall*CMDACT_IncreaseReplaySpeed)(int, bool);
...
extern int (__stdcall*ReplayFileListIterateItemProc)(char *a1);
...
extern void (__fastcall*PlayVideoFrame)(dialog *, __int16);
...
extern int (__fastcall*gluRdyZ_Secret)(dialog *dlg, dlgEvent *evt);
extern int (__fastcall*genericLightupBtnInteract)(dialog *dlg, struct dlgEvent *evt);
...
extern void (__fastcall*sub_4E4820)(dialog *a1);
...
char ProgressSecondaryOrder_Hidden(CUnit *a1);
...
extern char (__stdcall*gluLogin_DeleteCharacter)(dialog *a1);
extern char (__stdcall*gluLogin_CreateCharacter)(dialog *a1);
...
extern void (__stdcall*mouseOver_Loading_CB)(int a2);
...
extern int (__fastcall*sub_4EF7E0)(__int16 a3, unsigned int a2);
...
signed int TerrainCollision(CUnit *a1);
extern int (__stdcall*GetOthersLocation)(int);
...
extern int(*destroy_textbox_bin)();
...
extern int(*destroy_statfluf_bin)();
...
extern int(*destroy_statf10_bin)();
...
extern int (__fastcall*MaelStromProc)(CUnit *, CUnit *);
...
extern int (__thiscall*StasisFieldHit)(int position_x, CUnit *a2);
...
extern int (__stdcall *(&funcs_485FB0)[3])(int);
...
extern int& dword_50E176;
extern char(&aGluePalcs)[260];
extern char(&aGluePalrt)[11];
extern char(&aGluePalpd)[11];
extern char(&aGluePalpv)[11];
extern char(&aGluePalzd)[11];
extern char(&aGluePalzv)[11];
...
extern ButtonOrder(&stru_515DD0)[5];
extern ButtonOrder(&stru_515E38)[5];
extern ButtonOrder(&stru_515EA0)[7];
extern ButtonOrder(&stru_515F2C)[2];
extern ButtonOrder(&stru_515F58)[9];
extern ButtonOrder(&stru_51600C)[1];
extern ButtonOrder(&stru_516020)[9];
extern ButtonOrder(&stru_5160D8)[7];
extern ButtonOrder(&stru_516168)[6];
extern ButtonOrder(&stru_5161E0)[7];
extern ButtonOrder(&stru_516270)[8];
extern ButtonOrder(&stru_516310)[7];
extern ButtonOrder(&stru_5163A0)[7];
extern ButtonOrder(&stru_516430)[9];
extern ButtonOrder(&stru_5164E8)[9];
extern ButtonOrder(&stru_5165A0)[7];
extern ButtonOrder& stru_516630;
extern ButtonOrder(&stru_5167B0)[5];
extern ButtonOrder(&stru_516818)[9];
extern ButtonOrder(&stru_5168D0)[8];
extern ButtonOrder(&stru_516970)[1];
extern ButtonOrder(&stru_516988)[4];
extern ButtonOrder(&stru_5169D8)[3];
extern ButtonOrder(&stru_516A14)[3];
extern ButtonOrder(&stru_516A50)[2];
extern ButtonOrder(&stru_516A78)[5];
extern ButtonOrder(&stru_516AE0)[5];
extern ButtonOrder(&stru_516B48)[5];
extern ButtonOrder(&stru_516BB0)[4];
extern ButtonOrder(&stru_516C00)[3];
extern ButtonOrder(&stru_516C3C)[3];
extern ButtonOrder(&stru_516C78)[7];
extern ButtonOrder(&stru_516D08)[9];
extern ButtonOrder(&stru_516DC0)[9];
extern ButtonOrder(&stru_516E78)[8];
extern ButtonOrder(&stru_516F18)[7];
extern ButtonOrder(&stru_516FA8)[7];
extern ButtonOrder(&stru_517038)[7];
extern ButtonOrder(&stru_5170C8)[7];
extern ButtonOrder(&stru_517158)[7];
extern ButtonOrder(&stru_5171E8)[6];
extern ButtonOrder(&stru_517260)[7];
extern ButtonOrder(&stru_5172F0)[5];
extern ButtonOrder(&stru_517358)[6];
extern ButtonOrder(&stru_5173D0)[6];
extern ButtonOrder(&stru_517448)[2];
extern ButtonOrder(&stru_517470)[4];
extern ButtonOrder(&stru_5174C0)[8];
extern ButtonOrder(&stru_517560)[4];
extern ButtonOrder(&stru_5175B0)[7];
extern ButtonOrder(&stru_517640)[5];
extern ButtonOrder(&stru_5176A8)[4];
extern ButtonOrder(&stru_5176F8)[1];
extern ButtonOrder(&stru_51770C)[3];
extern ButtonOrder(&stru_517748)[7];
extern ButtonOrder(&stru_5177D8)[6];
extern ButtonOrder(&stru_517850)[7];
extern ButtonOrder(&scv_orders)[9];
extern ButtonOrder(&stru_517998)[9];
extern ButtonOrder(&stru_517A50)[5];
extern ButtonOrder(&stru_517AB8)[9];
extern ButtonOrder(&stru_517B70)[8];
extern ButtonOrder(&stru_517C10)[6];
extern ButtonOrder(&stru_517C88)[7];
extern ButtonOrder(&stru_517D18)[7];
extern ButtonOrder(&stru_517DA8)[8];
extern ButtonOrder(&stru_517E48)[6];
extern ButtonOrder(&stru_517EC0)[6];
extern ButtonOrder(&stru_517F38)[10];
extern ButtonOrder(&stru_518000)[1];
extern ButtonOrder(&stru_518014)[2];
extern ButtonOrder(&stru_51803C)[2];
extern ButtonOrder(&stru_518068)[11];
extern ButtonOrder(&stru_518148)[12];
extern ButtonOrder(&stru_518238)[12];
extern ButtonOrder(&stru_518328)[13];
extern ButtonOrder(&stru_518430)[4];
extern ButtonOrder(&stru_518480)[7];
extern ButtonOrder(&stru_518510)[6];
extern ButtonOrder(&stru_518588)[4];
extern ButtonOrder(&stru_5185D8)[5];
extern ButtonOrder(&stru_518640)[7];
extern ButtonOrder(&stru_5186D0)[6];
extern ButtonOrder(&stru_518748)[7];
extern ButtonOrder(&stru_5187D4)[1];
...
extern _SNETVERSIONDATA& snet_version_data;
...
extern Race& selectedSingleplayerRace;
extern Race(&single_player_opponent_races)[8];
...
extern void (__thiscall *&GameScreenLClickEvent)(dlgEvent *);
...
extern Race& statfluf_current_race;
...
extern IScriptProgram& program_state;
...
extern void (__fastcall *&dword_6D1234)(dialog *);
