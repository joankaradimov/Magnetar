...
extern int (__stdcall*loadImagesData_lowMem)(grpHead **a1, int a2, int a3, int a4, void *a5, void *a6);
extern void (__stdcall*loadImagesData)(LO_Overlays *a1, int a2, unsigned __int16 *a3, int a4, char *a5, _DWORD *a6);
