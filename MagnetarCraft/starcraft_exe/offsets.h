...
extern BOOL (__stdcall*BTNSCOND_HatcheryLairHive)(CUnit *a1);
...
extern void (__fastcall*BWFXN_QueueCommand)(const void *a1, unsigned int a2);
...
extern void (__fastcall*gluCustmInitPlayerTypes)(dialog *, __int16);
...
extern void (__stdcall*sub_4B9480)(dialog *a1);
...
extern void (__fastcall*UpdateUnitOrderData)(CUnit *this_);
...
extern void (__noreturn *(&off_50D1C0)[4])();
extern void (__noreturn *(&off_50D1C4)[3])();
extern void (__noreturn *(&off_50D1C8)[2])();
...
extern MusicTrack(&music_track)[6];
...
extern ButtonOrder(&stru_5178E0)[9];
...
extern __int16(&terran_sfx_related)[413];
extern __int16(&zerg_sfx_related)[327];
extern int& selectionSoundCounter;
extern __int16(&protoss_sfx_related)[396];
...
extern unsigned __int16& word_6D04C8;
