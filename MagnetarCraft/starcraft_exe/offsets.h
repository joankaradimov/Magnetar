...
extern int (__fastcall*renderTerrainGRPToCache)(grpFrame *a1, int a2);
...
extern int (__stdcall*getCreepAtAndSet)(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD);
extern int (__stdcall*getNumSurroundingCreepTiles)(int, int);
extern bool (__stdcall*BWFXN_CreepManagementCB)(int (__stdcall *a1)(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD), WORD *a2, int a3, int a4, int *a5);
...
extern bool (__fastcall*statdata_UnitWireframeTransit)(dialog *a1, dlgEvent *a2);
...
extern signed int (__fastcall*moveToXScrIncrease)(int a1, int a2);
int moveToXScrDecrease(int a1);
extern int (__fastcall*moveToYScrIncrease)(int a1, int a2);
...
extern ButtonOrder(&stru_515BE8)[3];
extern ButtonOrder(&stru_515C24)[3];
