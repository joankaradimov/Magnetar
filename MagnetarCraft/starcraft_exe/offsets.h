...
extern int (__stdcall*canDimensionsFitAt)(int, int a3, int, __int16 a2);
...
void Game_RECV(int a1, int a2, int a3);
...
int sub_4CDFF0(GameActionDataBlock *a1, _DWORD *a2, char *a3, char *dest, int *a5);
extern int (__fastcall*sub_4CE110)(char *dest, int a3, _DWORD *a2);
...
void ISCRIPT_UseLOFile(point *result, CImage *a2, unsigned __int8 a3, int a4);
...
void updateImageDirection(CImage *result, unsigned __int8 direction);
...
extern CImage *(__stdcall*ISCRIPT_CreateImage)(CImage *a1, int a2, char a3, char a4, ImageOrder image_order);
